...
constexpr
#endif
int material[6] = {100, 326, 360, 518, 1019, 100000};
...
int piece_square_table[6][64] =
{
    {
        0, 0, 0, 0, 0, 0, 0, 0,
        3, 19, 7, -40, -21, 19, 32, 2,
        0, 27, 1, 5, 11, 10, 29, 9,
        -2, 33, 10, 19, 21, 7, 13, 8,
        10, 34, 22, 39, 32, 29, 51, 29,
        74, 96, 74, 57, 77, 79, 130, 76,
        145, 162, 201, 127, 139, 133, 188, 184,
        0, 0, 0, 0, 0, 0, 0, 0,
    },
    {
        -113, -35, -51, -66, -3, -64, -35, -75,
        -73, -28, -11, 11, 13, 1, 22, -66,
        -53, -9, 9, 15, -15, 20, -15, -15,
        -23, 18, 31, 42, 35, 41, 22, 7,
        19, 22, 51, 74, 59, 54, 36, 14,
        2, 26, 50, 40, 49, 86, 0, -33,
        -52, 11, 27, 28, -32, 17, -48, -8,
        -105, -69, 3, -64, 39, -75, -27, -137,
    },
    {
        -42, -79, -25, -25, -39, -23, -96, -67,
        -51, 4, -37, 10, -2, -13, -2, -22,
        -48, 3, 16, 14, 8, 16, 4, -14,
        -2, 20, 0, 34, 16, 22, 0, 11,
        1, 27, 6, 19, 32, 32, 19, -5,
        -6, 36, 53, 46, 20, 39, 28, -9,
        -74, 4, 22, -27, 44, -7, -12, -107,
        9, 3, -32, 48, -30, -56, -22, -45,
    },
    {
        -53, -26, -22, -9, 11, -12, -66, -47,
        -57, -1, 2, -14, 5, -20, -25, -79,
        -25, -6, -24, -12, -3, -18, 12, -8,
        -29, 7, 13, 1, 14, -14, 36, -32,
        1, 22, 40, -2, 41, 39, 24, 13,
        10, 40, 49, 46, 41, 31, 43, 14,
        40, 39, 57, 58, 41, 37, 19, 17,
        16, 42, 21, 30, 47, 28, 7, 13,
    },
    {
        -33, -58, -19, -14, -83, 8, 10, -98,
        -68, -1, -18, -4, 8, -23, -32, 12,
        -16, 1, 7, 10, 9, -14, -17, -68,
        -28, -37, 24, -1, 23, 32, 3, -12,
        36, 21, 49, -16, 24, 48, 29, -4,
        11, 13, 38, 52, 50, 83, 29, 28,
        -41, 21, 25, 27, 63, 49, 49, -58,
        10, 32, 18, 51, 53, 49, 10, 43,
    },
    {
        10, 33, 43, 5, -10, -1, 34, -24,
        37, 60, 40, 28, -6, 15, 3, 18,
        -32, 41, 7, -13, -18, -12, 2, -7,
        -9, 49, 15, 41, 15, -12, 6, 17,
        11, 49, 51, 62, 62, 23, -14, -19,
        8, 22, 22, 42, 35, 36, 6, -67,
        -11, -45, 58, -7, 25, 12, 31, 5,
        -118, -154, -90, -41, -31, -128, -12, 28,
    },
};
...
double evaluation_error()
{
    ...
    for (auto& pos : tuning_positions)
    {
        ...
        error += std::pow(pos.second * 0.5 - 1. / (1. + std::pow(0.99538, evaluate())), 2);
    }
