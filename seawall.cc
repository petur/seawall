...
int piece_square_table[6][64] =
{
    {
        0, 0, 0, 0, 0, 0, 0, 0,
        9, 25, 15, -27, -20, 23, 29, 0,
        10, 29, 4, 6, 9, 7, 35, 4,
        10, 29, 16, 23, 22, 12, 18, 4,
        18, 35, 19, 43, 27, 13, 36, 14,
        85, 110, 80, 77, 95, 64, 118, 77,
        126, 172, 187, 116, 139, 169, 202, 149,
        0, 0, 0, 0, 0, 0, 0, 0,
    },
    {
        -138, -23, 5, -11, -26, -6, -14, -58,
        -13, -51, -26, 12, 18, 8, 0, -23,
        -39, -5, 10, 35, -2, 20, -3, -2,
        8, 20, 41, 35, 35, 55, 38, -1,
        6, 15, 47, 64, 64, 57, 18, 41,
        -34, 40, 46, 48, 42, 43, 8, -27,
        -45, -31, 28, -11, 9, 15, -38, -32,
        -145, -65, -11, -32, -1, -9, -43, -150,
    },
    {
        -71, -29, -17, -57, -12, -19, -63, -43,
        -50, 7, -28, 2, 8, -34, 10, -31,
        -41, 13, 20, 17, 15, 21, 7, -10,
        -37, 18, 18, 41, 28, 23, 13, -4,
        11, 16, 32, 38, 33, 33, 27, -10,
        -12, 22, 48, 49, 10, 41, 7, -22,
        -94, 18, 10, -11, 38, -24, 7, -87,
        4, -9, -31, 10, 7, -37, -59, -59,
    },
    {
        -39, -26, -14, 0, 7, -17, -25, -46,
        -22, -29, 1, 0, -4, -19, 4, -75,
        -23, 0, -8, -26, -1, -22, 0, -17,
        -11, 15, 2, -16, -5, 0, 19, -31,
        15, 15, 38, 16, 25, 36, 22, -1,
        14, 38, 48, 28, 23, 25, 32, 30,
        38, 44, 56, 45, 44, 39, 29, 20,
        9, 40, 26, 25, 40, 30, -1, 1,
    },
    {
        -27, -60, -21, -16, -51, -8, -26, -16,
        -105, -38, 6, -2, 10, 1, -20, -16,
        -29, -2, 11, 7, 9, 1, 13, -31,
        -16, -40, 20, -18, 9, 29, 5, -13,
        8, -5, 52, -3, 36, 42, 8, -25,
        13, 3, 36, 29, 46, 26, 46, 28,
        -33, -6, 29, 36, 61, 31, 32, -8,
        -21, -18, 31, 57, 16, -7, 1, 18,
    },
    {
        7, 16, 30, -8, -5, 9, 38, 3,
        5, 40, 22, 1, -27, 17, 15, 14,
        -41, 18, 8, 1, -5, -1, 15, 31,
        -21, 34, 32, 30, 13, 15, 7, 28,
        15, 42, 38, 45, 42, 30, 17, -4,
        29, 51, 49, 30, 30, 37, 13, -54,
        -47, 28, 47, 14, 22, -5, 37, 16,
        -109, -2, -58, -33, -9, -25, 0, -138,
    },
};
...
int evaluate()
{
    return 14 + position.piece_square_values[position.next] - position.piece_square_values[~position.next];
}
...
double evaluation_error()
{
    ...
    for (auto& pos : tuning_positions)
    {
        ...
        error += std::pow(pos.second * 0.5 - 1. / (1. + std::pow(0.99534, evaluate())), 2);
    }
