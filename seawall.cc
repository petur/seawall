...
constexpr
#endif
Score king_relative_pawn_psqt[8][48] =
{
    {
        {6, -10}, {9, 2}, {4, 3}, {-5, 4}, {2, -10}, {-6, -3}, {-2, -4}, {-2, 1},
        {8, -6}, {11, -6}, {-1, 2}, {-6, 4}, {-3, 2}, {0, -3}, {-3, -3}, {-2, 0},
        {13, -6}, {9, -6}, {0, -4}, {-1, -2}, {-4, -1}, {0, -8}, {1, -10}, {2, -5},
        {0, 6}, {3, 2}, {3, -4}, {4, -12}, {5, -13}, {5, -11}, {-1, -8}, {-1, -2},
        {8, 20}, {-13, 22}, {15, -14}, {26, -23}, {15, -15}, {10, -12}, {12, -7}, {-5, 14},
        {4, 10}, {-11, 5}, {11, 9}, {13, -9}, {15, -3}, {3, 3}, {8, 1}, {-2, 15},
    },
    {
        {4, -1}, {-2, -6}, {4, -1}, {7, -3}, {0, 0}, {0, -5}, {2, 1}, {0, 3},
        {-4, 1}, {-3, -3}, {6, 0}, {10, -1}, {-3, 0}, {-1, 0}, {-1, 7}, {-1, 1},
        {-5, 2}, {0, -1}, {7, 1}, {7, 3}, {4, -3}, {0, -1}, {-2, 1}, {-6, 1},
        {0, -4}, {4, -3}, {7, 1}, {5, -1}, {2, -4}, {4, -9}, {0, -9}, {-5, -4},
        {-2, -1}, {-7, 3}, {-16, 5}, {-10, -3}, {0, -8}, {-5, -8}, {-2, -9}, {-2, 2},
        {11, -11}, {-5, -4}, {-13, -12}, {1, 2}, {11, -9}, {-6, -17}, {-5, -6}, {11, -13},
    },
    {
        {-2, -11}, {-5, -10}, {-3, 0}, {-17, -3}, {-2, 1}, {-7, 2}, {0, -1}, {-2, 3},
        {6, -9}, {10, 1}, {6, 4}, {1, 3}, {2, 3}, {4, -2}, {1, -2}, {-1, 0},
        {13, -6}, {7, -4}, {-5, 10}, {-3, 2}, {1, 7}, {-7, 3}, {0, -7}, {3, -5},
        {2, -5}, {0, 8}, {-1, 10}, {6, -3}, {7, -1}, {11, -13}, {1, -7}, {-1, -5},
        {8, 22}, {7, 23}, {17, 12}, {21, -17}, {8, -24}, {7, -25}, {20, -27}, {1, -17},
        {24, 12}, {-3, 25}, {20, 11}, {-1, -14}, {6, -16}, {-3, -39}, {7, -15}, {10, -9},
    },
    {
        {-2, 2}, {-9, -6}, {3, -13}, {0, -16}, {0, -8}, {0, -4}, {2, 2}, {-5, 13},
        {-4, 1}, {-6, -4}, {5, -5}, {9, -3}, {2, 1}, {2, 1}, {0, 2}, {0, 3},
        {-1, 3}, {-2, -1}, {6, -3}, {5, 4}, {5, 4}, {-3, 4}, {4, 3}, {-1, 6},
        {-1, -3}, {4, -3}, {15, 3}, {3, 10}, {1, 1}, {3, -4}, {-2, 0}, {-2, -1},
        {13, -3}, {-3, 1}, {8, 13}, {-2, 7}, {7, -8}, {-6, -11}, {-3, -21}, {-2, -7},
        {16, -19}, {-6, -8}, {-1, -9}, {0, -7}, {2, -19}, {-14, -28}, {-7, -41}, {12, -24},
    },
    {
        {0, 23}, {-14, 11}, {2, 2}, {-1, 0}, {-4, -11}, {-21, 1}, {1, -1}, {3, 5},
        {2, -6}, {-2, 2}, {-3, -9}, {-19, -10}, {-1, 17}, {-2, -1}, {-6, 6}, {6, -3},
        {6, -8}, {0, -6}, {-3, -2}, {2, 2}, {5, 17}, {2, 3}, {4, -2}, {6, -10},
        {1, -5}, {-4, 15}, {17, 5}, {4, -3}, {24, -1}, {2, -4}, {-5, -6}, {-3, -5},
        {7, 3}, {0, 15}, {14, 12}, {23, -10}, {3, -11}, {0, -21}, {7, -40}, {-1, -34},
        {7, 7}, {2, 10}, {8, 8}, {-4, -7}, {1, -9}, {-8, -23}, {-2, -18}, {4, -62},
    },
    {
        {-2, 1}, {-13, 5}, {-2, 6}, {6, 7}, {-5, -6}, {-2, 2}, {-3, 11}, {1, 12},
        {-21, 6}, {-10, -3}, {3, 1}, {2, -2}, {-15, -4}, {-8, -6}, {-6, 5}, {-2, 7},
        {-6, 7}, {-9, -14}, {6, -6}, {2, -4}, {1, -6}, {9, 1}, {-2, 3}, {3, 3},
        {-1, 3}, {-4, -7}, {1, 10}, {-7, 12}, {0, -2}, {3, 13}, {11, 1}, {4, -4},
        {31, 3}, {-1, 3}, {-2, 10}, {-4, 22}, {-2, 7}, {-1, 3}, {-3, -23}, {-3, -26},
        {8, -22}, {3, -12}, {9, 16}, {7, 8}, {2, 6}, {-14, -16}, {-17, -35}, {-2, -55},
    },
    {
        {2, 24}, {6, 1}, {-5, -8}, {-1, 3}, {-5, -13}, {-9, 2}, {-4, -1}, {2, 3},
        {2, 6}, {6, 8}, {-1, 0}, {-20, -12}, {-5, 5}, {-2, -1}, {-5, -4}, {-6, 0},
        {9, 37}, {6, 39}, {-2, 1}, {3, 12}, {-2, 13}, {-1, -1}, {-2, -8}, {1, -1},
        {0, -2}, {-10, 7}, {15, 1}, {2, -5}, {24, -4}, {4, -10}, {-4, -7}, {-4, -5},
        {6, -10}, {-2, 14}, {12, 4}, {24, -10}, {2, -15}, {2, -18}, {4, -35}, {1, -32},
        {-1, -21}, {-2, 6}, {10, 12}, {-5, -10}, {-2, -10}, {-8, -16}, {1, -10}, {2, -63},
    },
    {
        {3, -1}, {-2, 4}, {-2, 5}, {6, 5}, {-3, -5}, {-3, -14}, {0, 8}, {-1, 3},
        {-14, 4}, {-8, 0}, {4, 12}, {7, 0}, {-17, -6}, {-13, -1}, {-3, 4}, {-4, 3},
        {-6, 26}, {-5, 11}, {11, 30}, {6, 32}, {6, 7}, {8, 13}, {0, 2}, {-3, -2},
        {-1, -12}, {-2, -16}, {11, 14}, {3, 25}, {-1, -2}, {1, 3}, {10, 1}, {-3, -4},
        {24, -9}, {-5, -10}, {3, 11}, {-3, 23}, {-4, 6}, {-1, -12}, {-7, -18}, {-7, -31},
        {4, -41}, {-3, -32}, {2, 11}, {5, 12}, {5, 6}, {-19, -26}, {-7, -30}, {-1, -45},
    },
};
...
Score evaluate_king_relative()
{
    ...
    unsigned king_idx = ((rel_king_sq & 48) >> 3) | ((rel_king_sq & 2) >> 1);
