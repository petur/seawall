...
{
    {
        ...
        {8, 57}, {12, 41}, {44, 64}, {64, 14}, {60, -10}, {-48, 0}, {-4, 37}, {-17, 72},
        {10, 121},
    },
    {
        {55, 67}, {42, 51}, {25, -16}, {16, 22}, {13, 1}, {35, 32}, {4, 3}, {6, 14},
        {10, 38}, {11, 35}, {40, 37}, {36, 25}, {72, -22}, {12, -4}, {0, -28}, {32, 66},
        {23, 8},
    },
    {
        {40, 74}, {26, 84}, {48, -27}, {22, 25}, {11, 1}, {51, 16}, {0, 7}, {31, 2},
        {25, 28}, {24, 23}, {50, 27}, {107, -17}, {47, -13}, {3, 0}, {5, -24}, {31, 78},
        {10, 43},
    },
    {
        {43, 73}, {19, 67}, {52, -33}, {16, 22}, {18, -4}, {28, 25}, {-4, 6}, {27, 2},
        {11, 27}, {12, 26}, {55, 9}, {100, -14}, {38, -12}, {21, -2}, {-64, -51}, {36, 62},
        {-29, -16},
    },
    {
        {43, 73}, {43, 100}, {71, -37}, {13, 10}, {-18, 10}, {18, 5}, {5, 1}, {63, -16},
        {-5, 18}, {-20, 42}, {18, 23}, {117, -26}, {9, 15}, {2, 4}, {-10, -63}, {-5, 74},
        {5, 81},
    },
    {
        {16, 76}, {39, 122}, {82, -39}, {17, 2}, {1, 4}, {33, 9}, {4, 6}, {57, -14},
        {-22, 34}, {-13, 46}, {22, 6}, {90, -18}, {7, 6}, {11, -2}, {-128, -62}, {55, 34},
        {31, 23},
    },
    {
        {45, 146}, {26, 119}, {82, -43}, {26, -9}, {-21, 21}, {-8, -15}, {-26, 14}, {10, 8},
        {-20, 28}, {-20, 41}, {21, 11}, {73, -16}, {7, 36}, {-3, 3}, {8, -56}, {11, 77},
        {25, 60},
    },
    {
        {11, 76}, {38, 128}, {57, -43}, {9, 8}, {-3, 10}, {34, 8}, {-11, 8}, {15, 5},
        {-24, 40}, {-42, 51}, {21, 4}, {52, -10}, {8, 32}, {7, 7}, {-36, -46}, {22, 37},
        {-2, 14},
    },
};
