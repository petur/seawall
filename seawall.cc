...
constexpr
#endif
Weight piece_evals[8][24] =
{
    {
        {54, 81}, {38, 69}, {23, -5}, {13, 25}, {-12, -2}, {35, 32}, {-6, -8}, {3, 19},
        {-9, -46}, {-9, -43}, {47, 53}, {4, 56}, {10, 16}, {7, 71}, {-64, -12}, {-52, 7},
        {-55, 12}, {-4, 46}, {-8, 56}, {18, 110}, {-53, 0}, {1, 29}, {-11, 70}, {22, 97},
    },
    {
        {55, 54}, {36, 49}, {22, -9}, {14, 17}, {-12, -3}, {35, 24}, {-4, -5}, {3, 16},
        {-11, -36}, {-14, -32}, {40, 34}, {9, 54}, {-3, 22}, {19, 62}, {-26, -26}, {-63, 19},
        {9, 2}, {-2, -25}, {40, 54}, {24, 4}, {12, -3}, {-23, -27}, {28, 82}, {14, 5},
    },
    {
        {55, 58}, {9, 76}, {59, -23}, {16, 20}, {-11, 0}, {42, 20}, {-1, -6}, {30, 1},
        {-28, -25}, {-30, -22}, {55, 20}, {-13, 70}, {-1, 28}, {65, 36}, {-111, 19}, {-46, 13},
        {8, 2}, {10, -15}, {52, 52}, {27, 39}, {1, 4}, {-8, -27}, {32, 78}, {-4, 61},
    },
    {
        {50, 50}, {28, 69}, {55, -24}, {10, 20}, {-21, 7}, {28, 23}, {3, -7}, {28, -1},
        {-9, -30}, {-20, -20}, {60, 9}, {-14, 71}, {0, 26}, {59, 34}, {-100, 16}, {-34, 13},
        {22, 2}, {-58, -42}, {50, 55}, {-20, -42}, {20, 4}, {-128, -34}, {45, 81}, {-55, -34},
    },
    {
        {31, 72}, {33, 114}, {68, -21}, {18, 7}, {12, -6}, {35, 16}, {1, 2}, {71, -16},
        {8, -34}, {15, -44}, {27, 39}, {11, 53}, {-10, 46}, {29, 36}, {-128, 24}, {-4, -10},
        {3, -16}, {-30, -58}, {2, 56}, {-39, 41}, {-16, 7}, {-22, -48}, {5, 75}, {-37, 47},
    },
    {
        {7, 69}, {23, 119}, {91, -28}, {23, -1}, {-5, 5}, {32, 20}, {2, -1}, {46, -5},
        {13, -38}, {25, -46}, {18, 14}, {25, 57}, {-9, 47}, {45, 22}, {-107, 20}, {-6, -2},
        {11, -11}, {-155, -50}, {45, 32}, {-13, -10}, {18, -4}, {-176, -44}, {70, 53}, {-15, -17},
    },
    {
        {19, 135}, {5, 121}, {79, -24}, {25, -3}, {27, -9}, {18, 25}, {21, -7}, {20, 6},
        {8, -43}, {22, -45}, {19, 29}, {2, 46}, {-22, 56}, {15, 63}, {-100, 15}, {1, -26},
        {3, -45}, {-4, -59}, {-14, 35}, {41, 98}, {-22, -1}, {9, -55}, {-5, 64}, {58, 107},
    },
    {
        {22, 109}, {3, 117}, {68, -20}, {6, -4}, {14, 0}, {50, 29}, {7, -2}, {17, 14},
        {24, -59}, {41, -67}, {30, 32}, {5, 30}, {11, 56}, {49, 54}, {-89, 10}, {-6, -18},
        {8, -17}, {-28, -49}, {15, 38}, {18, 41}, {3, 3}, {-59, -28}, {28, 63}, {5, 11},
    },
};
...
Score evaluate_pieces(const Mobility& mobility)
{
    ...
    const
#endif
    Weight* pe = piece_evals[eval_offset];
