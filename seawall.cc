...
constexpr
#endif
int material[6] = {100, 343, 380, 567, 1121, 100000};
...
int piece_square_table[6][64] =
{
    {
        0, 0, 0, 0, 0, 0, 0, 0,
        7, 25, 11, -23, -20, 21, 33, 7,
        9, 20, 11, 12, 11, 17, 43, 11,
        16, 24, 23, 29, 27, 16, 25, 7,
        27, 33, 23, 50, 29, 21, 37, 10,
        105, 95, 80, 106, 88, 55, 97, 80,
        167, 177, 165, 158, 133, 163, 165, 126,
        0, 0, 0, 0, 0, 0, 0, 0,
    },
    {
        -137, -27, -27, -19, -7, 2, -19, -44,
        -76, -24, -45, 15, 22, -3, -11, -33,
        -34, -7, 14, 41, 18, 26, 24, -28,
        22, -1, 43, 33, 40, 47, 35, -4,
        -20, 15, 41, 80, 68, 62, 20, 57,
        -42, 23, 73, 69, 50, 47, 36, -38,
        -32, -32, 64, 9, 26, 29, 30, -17,
        -145, -126, 42, -25, -14, -12, -10, -89,
    },
    {
        -55, -30, -21, -42, -26, -21, -59, -79,
        -60, 12, -30, 5, 6, -42, 5, -29,
        -25, 30, 12, 21, 22, 24, 9, -21,
        5, 13, 25, 32, 36, 23, 5, 21,
        25, 16, 34, 25, 44, 33, 18, 15,
        -6, 44, 34, 48, 31, 34, -5, -6,
        -54, 19, 6, -8, -3, 11, 32, -78,
        3, -21, -27, -4, -28, 7, 24, 0,
    },
    {
        -30, -26, -13, 7, 12, -9, -26, -45,
        -48, -34, 3, 17, -9, -13, -11, -74,
        -32, -9, -6, -15, -9, -32, -10, -25,
        -8, 16, 1, -3, -3, -19, 9, -23,
        -3, 34, 29, 20, 18, 34, 11, 34,
        45, 43, 58, 32, 41, 16, 48, 24,
        39, 52, 59, 43, 35, 37, 32, 23,
        15, 31, 5, 12, 33, 10, 21, 8,
    },
    {
        -35, -30, -16, -15, -24, -8, -95, -80,
        -76, -15, -10, -13, -3, -8, -90, -7,
        -38, -2, 11, -4, 12, -6, 20, -47,
        -18, -22, 10, -34, 9, 37, 1, -40,
        9, 3, 63, -2, 42, 32, -6, -30,
        9, 23, 53, 21, 51, 51, 26, 32,
        -21, 9, 36, 33, 49, 24, 23, -8,
        -30, -9, 40, 10, 48, -9, 22, -2,
    },
    {
        5, 11, 26, -16, -7, -6, 30, -10,
        8, 35, 12, -5, -16, 14, 2, -4,
        -6, 10, 2, 13, 16, 19, 6, -7,
        19, 39, 33, 49, 29, 34, 28, 12,
        6, 55, 64, 49, 61, 49, 51, 25,
        44, 63, 38, 47, 45, 77, 55, -18,
        47, 39, 47, 40, 40, 48, 48, 42,
        -6, -75, 6, 19, 36, -16, -48, -194,
    },
};
...
double evaluation_error()
{
    ...
    for (auto& pos : tuning_positions)
    {
        ...
        error += std::pow(pos.second * 0.5 - 1. / (1. + std::pow(0.99529, evaluate())), 2);
    }
