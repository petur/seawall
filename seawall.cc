...
constexpr
#endif
int material[6] = {100, 354, 393, 589, 1175, 100000};
...
int piece_square_table[6][64] =
{
    {
        0, 0, 0, 0, 0, 0, 0, 0,
        10, 26, 12, -16, -22, 23, 38, 10,
        19, 23, 11, 16, 10, 19, 43, 17,
        21, 24, 17, 35, 21, 22, 24, 12,
        37, 38, 24, 50, 32, 17, 34, 17,
        104, 102, 82, 123, 84, 57, 104, 89,
        207, 194, 142, 181, 149, 153, 162, 140,
        0, 0, 0, 0, 0, 0, 0, 0,
    },
    {
        -83, -26, -31, -11, -1, -1, -15, -37,
        -79, -40, -54, 17, 21, -1, -18, -21,
        -20, -9, 14, 40, 28, 24, 16, -23,
        25, 2, 49, 36, 43, 53, 24, -1,
        -7, 22, 49, 77, 63, 60, 23, 55,
        -6, 19, 74, 73, 54, 58, 49, -34,
        -15, -15, 47, 37, 35, 47, 52, -37,
        -143, -67, 43, -28, -3, 25, -24, -107,
    },
    {
        -59, -32, -21, -47, -36, -15, -47, -63,
        -70, 16, -15, 6, 13, -31, 12, -32,
        -4, 15, 11, 21, 16, 24, 23, -3,
        5, 9, 29, 34, 35, 23, 5, 14,
        26, 18, 33, 25, 44, 29, 18, 13,
        16, 60, 27, 54, 34, 27, 0, -3,
        -74, 26, 18, -13, 6, 23, 18, -30,
        -12, -28, 26, -9, -30, 10, 11, -13,
    },
    {
        -27, -19, -8, 9, 7, -11, -29, -52,
        -39, -32, 6, 15, -7, -3, -11, -78,
        -35, -5, 3, -25, -11, -34, -8, -29,
        -10, 20, -2, 7, -7, 0, 15, -11,
        7, 49, 33, 40, 23, 39, 20, 29,
        49, 46, 48, 33, 45, 25, 44, 16,
        41, 59, 55, 48, 37, 42, 29, 27,
        9, 41, 18, 25, 30, 29, 22, 14,
    },
    {
        -23, -23, -19, -12, -21, -17, -113, -108,
        -79, -30, -6, -11, -6, -9, -85, -16,
        -13, -9, -5, -5, 3, -13, 7, -26,
        -5, -50, 25, -25, -4, 25, 4, -40,
        12, -5, 54, 7, 47, 30, -7, -18,
        -6, 33, 43, 31, 64, 50, 36, 30,
        -10, 14, 20, 26, 36, 35, 43, -10,
        -22, -29, 19, 28, 52, 22, 39, -23,
    },
    {
        0, 11, 20, -26, -8, -9, 28, -7,
        3, 28, 7, -6, -18, 13, 7, -6,
        -2, 20, 10, 12, 20, 16, 12, -2,
        24, 43, 46, 58, 35, 44, 37, 4,
        27, 52, 61, 63, 60, 49, 45, 40,
        73, 55, 45, 71, 61, 65, 72, 52,
        69, 90, 59, 55, 48, 62, 47, 25,
        -12, -62, 4, 40, 46, 15, -57, -206,
    },
};
...
double evaluation_error()
{
    ...
    for (auto& pos : tuning_positions)
    {
        ...
        error += std::pow(pos.second * 0.5 - 1. / (1. + std::pow(0.99528, evaluate())), 2);
    }
