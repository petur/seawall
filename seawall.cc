...
{
    {
        {4, -7}, {15, 0}, {24, -8}, {10, -1}, {-8, 3}, {-14, -5}, {-17, 4}, {-1, 12},
        {1, -3}, {17, -7}, {5, -3}, {2, -1}, {-6, 0}, {6, -11}, {-25, 7}, {-9, 4},
        {12, 0}, {10, -3}, {9, 8}, {18, 4}, {-7, -3}, {-12, 0}, {-6, -13}, {-13, 3},
        {12, 1}, {-4, 5}, {15, 6}, {5, 3}, {2, 0}, {6, -10}, {-6, -2}, {-4, 0},
        {10, 5}, {4, 9}, {5, 7}, {15, -15}, {19, -21}, {22, -16}, {-2, -7}, {6, 3},
        {4, -1}, {12, 4}, {13, -10}, {-3, -10}, {16, -16}, {18, -27}, {-17, -15}, {7, 1},
    },
    {
        {2, -6}, {9, -4}, {22, -6}, {7, 0}, {-8, 3}, {-11, -5}, {-10, 6}, {-1, 11},
        {-2, -2}, {15, -10}, {8, 2}, {3, 1}, {-6, 0}, {4, -5}, {-14, 8}, {-6, 7},
        {6, -2}, {8, 2}, {14, 7}, {7, 5}, {-2, -1}, {-5, -2}, {-8, -3}, {-10, 4},
        {0, -3}, {-1, 6}, {16, -3}, {9, -1}, {-8, -1}, {7, -14}, {-8, -4}, {-7, 0},
        {4, 0}, {3, 10}, {3, 1}, {12, -17}, {15, -24}, {20, -14}, {-7, -16}, {-1, -4},
        {1, 0}, {9, 0}, {9, -12}, {-1, -6}, {20, -14}, {16, -30}, {-17, -13}, {6, -1},
    },
    {
        {0, 0}, {6, -1}, {1, 0}, {2, 4}, {5, 0}, {-2, 2}, {-3, -6}, {4, -1},
        {0, -1}, {1, 7}, {-1, 1}, {-2, 0}, {9, -1}, {4, 0}, {-4, -4}, {-1, -1},
        {-4, -1}, {1, -2}, {2, -3}, {8, -9}, {5, 3}, {6, 1}, {1, -5}, {-4, 0},
        {-3, -7}, {3, -9}, {4, -8}, {4, -10}, {4, -4}, {9, -8}, {1, -1}, {0, 3},
        {-5, 5}, {3, -10}, {-4, -7}, {11, -14}, {-3, -10}, {-3, -5}, {-22, 9}, {-2, -1},
        {-21, 11}, {-3, -2}, {7, -19}, {22, -18}, {16, -9}, {10, -4}, {-18, 2}, {-8, 11},
    },
    {
        {0, -1}, {-1, -3}, {-3, -3}, {1, -5}, {-2, -2}, {2, 4}, {6, 3}, {4, -8},
        {0, -1}, {0, -5}, {0, -1}, {-1, 1}, {-4, 2}, {0, -1}, {9, -6}, {6, -5},
        {2, -2}, {1, -9}, {0, -6}, {-1, -5}, {0, -8}, {0, -8}, {6, -4}, {10, -2},
        {0, -4}, {2, -9}, {6, -9}, {6, -13}, {5, -12}, {8, -13}, {0, 2}, {1, 2},
        {-2, 9}, {7, -4}, {3, -7}, {16, -17}, {25, -19}, {9, -12}, {-14, 16}, {5, 20},
        {-25, 31}, {1, 4}, {14, -8}, {30, -16}, {21, -9}, {17, -2}, {-18, 6}, {-9, 14},
    },
    {
        {-19, -12}, {-6, -16}, {21, -15}, {-8, -1}, {-6, -11}, {-8, -7}, {-17, 6}, {3, 9},
        {-2, -1}, {3, 6}, {16, 1}, {-4, 0}, {0, 2}, {12, -10}, {-11, 10}, {-1, 4},
        {4, 2}, {6, -1}, {6, 18}, {4, 3}, {-1, 10}, {-5, -1}, {-11, -3}, {-3, 6},
        {5, -6}, {-1, 9}, {21, 7}, {5, 0}, {-3, 7}, {-1, -3}, {-1, -10}, {-4, 1},
        {35, 4}, {7, 24}, {9, 11}, {12, -8}, {11, -27}, {16, -23}, {-9, -22}, {3, -8},
        {18, -5}, {11, 9}, {20, -9}, {6, -7}, {17, -22}, {11, -42}, {-19, -14}, {2, -30},
    },
    {
        {-16, 4}, {1, -9}, {19, -19}, {-12, -6}, {-9, -14}, {-7, -4}, {-6, 7}, {2, 15},
        {-2, -2}, {3, -6}, {6, -2}, {-4, -7}, {1, 1}, {14, -10}, {-11, 6}, {-2, 7},
        {4, 3}, {4, -2}, {-2, 3}, {11, 2}, {-3, 9}, {-4, 1}, {-4, 1}, {-6, 8},
        {-1, -4}, {-2, -2}, {14, 5}, {5, 6}, {-4, 6}, {-8, -3}, {-1, -5}, {-2, 2},
        {17, -8}, {1, -4}, {9, 11}, {14, -2}, {16, -20}, {14, -19}, {-5, -19}, {7, -6},
        {17, -21}, {5, -15}, {18, -11}, {12, -4}, {17, -22}, {15, -36}, {-16, -14}, {0, -28},
    },
    {
        {1, 4}, {-1, 1}, {-2, 0}, {-4, 4}, {-4, -15}, {-5, -9}, {-10, -5}, {-1, 3},
        {0, 0}, {3, 0}, {3, 1}, {3, 1}, {6, -1}, {3, -4}, {-7, -1}, {-3, 2},
        {4, 3}, {2, 2}, {-7, 10}, {8, 1}, {1, 7}, {2, 0}, {-2, -3}, {0, 1},
        {4, -7}, {3, -3}, {1, -2}, {2, -3}, {6, 7}, {6, 3}, {0, -1}, {2, -3},
        {3, -10}, {7, -24}, {18, -23}, {12, -15}, {15, -6}, {18, 7}, {-12, 13}, {10, -5},
        {13, -14}, {-5, -33}, {16, -44}, {21, -22}, {15, -16}, {22, -7}, {-18, 21}, {3, -11},
    },
    {
        {-2, -1}, {-1, 0}, {-2, 0}, {-3, 7}, {-5, -15}, {0, 0}, {-12, -7}, {-2, -7},
        {1, -4}, {0, -4}, {1, -1}, {3, 2}, {7, 1}, {16, -5}, {-1, 4}, {-4, -3},
        {3, -6}, {1, -7}, {-6, 7}, {11, 1}, {0, -1}, {1, 4}, {1, -1}, {2, 0},
        {2, -7}, {1, -6}, {-2, -9}, {4, -3}, {3, -1}, {2, 6}, {7, 4}, {-1, -2},
        {1, -14}, {8, -24}, {14, -30}, {8, -26}, {15, -8}, {23, 6}, {0, 18}, {17, 17},
        {17, -10}, {-2, -30}, {18, -44}, {20, -22}, {14, -16}, {24, -3}, {-16, 27}, {4, 12},
    },
    {
        {-4, 5}, {-13, 10}, {-5, 13}, {-12, -2}, {-5, -12}, {-19, 1}, {-23, 16}, {-18, 19},
        {-7, 3}, {-1, 2}, {-13, 0}, {-4, -2}, {1, 6}, {-4, -9}, {-10, 6}, {7, -2},
        {-8, 1}, {-1, -9}, {-11, 9}, {1, 1}, {4, 4}, {-6, 2}, {-7, 5}, {5, 2},
        {-4, 4}, {3, 21}, {0, 13}, {2, 2}, {-1, -1}, {1, 7}, {-5, -6}, {9, -7},
        {5, 14}, {1, 10}, {8, 12}, {11, 9}, {-1, 2}, {11, -19}, {-9, -32}, {-6, -26},
        {26, -7}, {10, -7}, {21, 9}, {14, -2}, {4, -9}, {-13, -18}, {7, -72}, {-12, -65},
    },
    {
        {-2, 4}, {-15, 14}, {-7, 10}, {-9, 1}, {-7, -13}, {-15, 3}, {-22, 13}, {-19, 21},
        {-7, 4}, {-3, -1}, {-12, 9}, {8, 0}, {-2, -12}, {-4, -11}, {-8, 6}, {5, 0},
        {-4, 12}, {-1, -11}, {-17, 9}, {-4, -1}, {-2, -2}, {-8, -1}, {-5, 7}, {5, 3},
        {-1, 12}, {4, 6}, {0, 16}, {2, 11}, {-2, -7}, {1, 8}, {-3, 0}, {7, -8},
        {3, 15}, {5, 13}, {11, 13}, {12, 12}, {0, 5}, {16, -7}, {-8, -28}, {-3, -26},
        {20, -13}, {8, -13}, {22, 13}, {9, -2}, {6, -7}, {-9, -16}, {8, -69}, {-8, -62},
    },
    {
        {-6, 7}, {-7, 12}, {-6, 2}, {-12, -7}, {4, 11}, {-19, 11}, {-32, 11}, {-33, 23},
        {2, 7}, {1, 0}, {11, 6}, {10, -1}, {0, -4}, {-6, -5}, {-24, 4}, {-1, -3},
        {2, -2}, {11, 0}, {-2, 12}, {0, -9}, {-3, -2}, {-13, -3}, {-12, -12}, {-1, 0},
        {-4, 5}, {1, 3}, {2, 19}, {4, 6}, {-3, 11}, {-2, 8}, {-2, -14}, {6, -6},
        {1, -34}, {1, -22}, {0, -3}, {7, 9}, {4, 7}, {16, 3}, {-6, 4}, {11, -4},
        {1, -57}, {-5, -45}, {15, -38}, {17, 3}, {15, 0}, {3, 10}, {36, -7}, {11, -13},
    },
    {
        {-7, 7}, {-6, 6}, {-5, 0}, {-12, -4}, {3, 10}, {-18, 10}, {-29, 22}, {-28, 39},
        {-1, -1}, {-1, -3}, {11, -4}, {10, 3}, {-4, -7}, {-9, -8}, {-21, 7}, {-2, -2},
        {0, -7}, {11, -6}, {-4, 10}, {4, 16}, {1, 2}, {-19, -6}, {-3, -3}, {-5, -8},
        {-6, -2}, {-1, -3}, {-3, -2}, {2, 5}, {-16, 8}, {4, 10}, {3, -1}, {6, -10},
        {-3, -40}, {-2, -28}, {-5, -8}, {6, 4}, {3, 6}, {18, 9}, {-1, 9}, {12, -7},
        {0, -59}, {-4, -45}, {14, -43}, {12, -3}, {11, -5}, {3, 11}, {35, -10}, {16, 2},
    },
    {
        {2, 12}, {-11, 2}, {-6, 7}, {-4, 1}, {-3, -8}, {-15, 1}, {-19, 12}, {-13, 19},
        {-5, 16}, {4, 15}, {-1, 24}, {0, -3}, {-6, -5}, {-2, -8}, {-11, 4}, {5, -6},
        {6, 42}, {3, 36}, {10, 36}, {4, 31}, {-4, -2}, {-4, 2}, {-4, 4}, {-3, 6},
        {-15, -3}, {10, -1}, {-2, 20}, {4, 9}, {-3, -4}, {-3, -11}, {-2, -4}, {13, -6},
        {1, -12}, {5, 13}, {8, 14}, {8, 18}, {0, -17}, {9, -14}, {-8, -33}, {2, -23},
        {16, -30}, {3, -13}, {23, 12}, {11, -4}, {6, 2}, {-13, -33}, {7, -56}, {-10, -50},
    },
    {
        {1, 11}, {-10, 5}, {-4, 8}, {-6, 5}, {-4, -8}, {-18, -2}, {-19, 13}, {-14, 16},
        {-5, 13}, {0, 8}, {-2, 26}, {3, 3}, {-7, -10}, {-3, -5}, {-11, 4}, {4, -8},
        {0, 38}, {2, 31}, {13, 41}, {6, 31}, {0, 0}, {-3, 3}, {-3, 3}, {-3, 4},
        {-14, -4}, {5, -2}, {-2, 20}, {7, 16}, {-7, -8}, {-4, -15}, {-2, -7}, {15, -4},
        {-3, -3}, {2, -2}, {10, 16}, {9, 18}, {-2, -17}, {7, -15}, {-11, -32}, {-2, -28},
        {16, -35}, {2, -19}, {22, 13}, {12, -1}, {9, 6}, {-13, -33}, {7, -55}, {-10, -46},
    },
    {
        {-13, 0}, {-4, 9}, {-7, 2}, {-11, -10}, {0, 10}, {-21, 9}, {-27, 15}, {-22, 15},
        {-1, -1}, {-3, -6}, {-1, 1}, {1, -4}, {-4, -6}, {2, -3}, {-18, 6}, {1, 1},
        {5, 4}, {3, -15}, {-2, 15}, {6, 10}, {1, 19}, {-6, 21}, {-5, 24}, {-9, 31},
        {-6, -11}, {3, 0}, {-7, 4}, {0, 7}, {-4, 17}, {4, 17}, {-6, -8}, {1, -12},
        {-7, -59}, {0, -29}, {-4, -10}, {2, 4}, {-1, 10}, {9, 1}, {-10, -12}, {6, -16},
        {-6, -64}, {-6, -41}, {10, -37}, {14, -2}, {9, -5}, {-3, 10}, {24, -20}, {11, -32},
    },
    {
        {-10, 0}, {-5, 6}, {-10, 0}, {-14, -12}, {3, 12}, {-20, 8}, {-30, 15}, {-20, 16},
        {-4, -5}, {-5, -12}, {2, 3}, {1, -6}, {-1, -6}, {2, 1}, {-16, 7}, {1, 0},
        {0, -13}, {-1, -20}, {-5, 10}, {4, 11}, {0, 18}, {-9, 11}, {-2, 30}, {-8, 34},
        {-8, -13}, {1, -6}, {-3, 2}, {0, 4}, {-4, 13}, {1, 10}, {-5, 0}, {2, -9},
        {-7, -56}, {-3, -31}, {-6, -7}, {1, 2}, {1, 7}, {10, 3}, {-9, -6}, {4, -14},
        {-7, -65}, {-4, -38}, {10, -38}, {16, 3}, {6, -5}, {3, 14}, {27, -15}, {11, -26},
    },
};
...
Score evaluate_king_relative()
{
    ...
    unsigned king_sq = first_square(position.type_bb[KING] & position.color_bb[C]) ^ flip;
    unsigned king_idx = ((king_sq >> 4) << 2) | ((king_sq & 6) >> 1);
        ...
        for (int n = 0; n < 4; n++)
        {
            ...
            for (auto& v : variables)
            {
                if (v.improvement <= cutoff)
                    break;
                find_best_value(v, best_error, 31 / (n + k + 1), 0, 1);
            }
        }
    }
