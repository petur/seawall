...
{
    {
        {-4, -3}, {-5, 1}, {2, 1}, {-1, -8}, {-2, 0}, {1, 0}, {0, -1}, {-3, 4},
        {-39, 12}, {-27, 24}, {-33, 28}, {-33, 21}, {-29, 22}, {-2, 15}, {4, 8}, {-35, 1},
        {-38, -3}, {-26, 2}, {-34, -2}, {-25, -8}, {-11, -17}, {-19, -2}, {8, -16}, {-33, -11},
        {-33, 2}, {-23, 9}, {3, -24}, {12, -46}, {24, -42}, {14, -23}, {7, -4}, {-26, -8},
        {-26, 63}, {-4, 49}, {-8, 28}, {18, 3}, {30, 0}, {15, 18}, {6, 43}, {-7, 48},
        {25, 129}, {28, 133}, {47, 95}, {47, 72}, {36, 81}, {66, 91}, {41, 132}, {22, 128},
        {211, 215}, {135, 248}, {103, 255}, {93, 243}, {61, 252}, {48, 267}, {51, 277}, {132, 253},
        {-1, -8}, {-3, -5}, {1, -5}, {2, 4}, {-3, -5}, {-1, -1}, {-3, 1}, {-3, -2},
    },
    {
        {-57, -91}, {-29, -86}, {-25, -51}, {-16, -48}, {-9, -48}, {-12, -60}, {-26, -78}, {-58, -86},
        {-39, -79}, {-26, -36}, {-13, -18}, {2, -10}, {2, -10}, {9, -28}, {-12, -33}, {-27, -64},
        {-31, -55}, {-7, -14}, {11, 15}, {23, 23}, {30, 24}, {16, 10}, {6, -13}, {-21, -44},
        {-7, -26}, {16, 1}, {41, 30}, {44, 38}, {44, 37}, {52, 29}, {33, 1}, {4, -22},
        {4, -21}, {22, 7}, {57, 30}, {73, 31}, {56, 43}, {55, 34}, {32, 15}, {18, -23},
        {-30, -5}, {39, -13}, {64, 19}, {85, 19}, {78, 17}, {116, -2}, {45, -8}, {-12, -11},
        {-41, -29}, {-22, -7}, {39, -9}, {55, -1}, {47, -2}, {52, -20}, {-20, -13}, {-12, -39},
        {-180, -30}, {-102, 6}, {-87, 21}, {-36, 5}, {-21, -5}, {-167, 44}, {-106, 10}, {-108, -70},
    },
    {
        {8, -73}, {7, -56}, {-2, -43}, {-26, -28}, {-20, -35}, {-20, -36}, {-12, -57}, {-7, -66},
        {15, -52}, {18, -42}, {10, -32}, {-5, -16}, {6, -27}, {23, -40}, {17, -34}, {-1, -68},
        {3, -45}, {17, -15}, {11, 8}, {9, 9}, {10, 12}, {13, -1}, {18, -22}, {-6, -39},
        {-10, -34}, {2, -7}, {7, 18}, {23, 23}, {16, 19}, {10, 6}, {-3, -10}, {6, -43},
        {-16, -24}, {0, 2}, {4, 12}, {40, 14}, {27, 19}, {14, 12}, {14, -5}, {-10, -23},
        {-30, -10}, {-3, 5}, {-7, 16}, {21, 0}, {19, 4}, {32, 13}, {19, 4}, {-12, -10},
        {-71, 9}, {-53, 17}, {-23, 4}, {-56, 23}, {-64, 27}, {-33, 13}, {-54, 19}, {-57, -8},
        {-60, 10}, {-76, 21}, {-139, 46}, {-111, 33}, {-114, 35}, {-180, 55}, {-70, 17}, {-45, 4},
    },
    {
        {-15, -29}, {-19, -28}, {-11, -29}, {-8, -28}, {-3, -35}, {-3, -29}, {-23, -31}, {-25, -42},
        {-37, -36}, {-43, -27}, {-21, -27}, {-20, -27}, {-14, -32}, {2, -46}, {-15, -52}, {-87, -32},
        {-49, -8}, {-43, -7}, {-47, -1}, {-47, -2}, {-35, -11}, {-38, -9}, {-20, -26}, {-39, -28},
        {-48, 11}, {-56, 22}, {-46, 20}, {-46, 18}, {-44, 13}, {-38, 12}, {-45, 13}, {-43, -3},
        {-35, 23}, {-31, 24}, {-19, 23}, {-13, 17}, {-24, 19}, {-11, 16}, {-30, 19}, {-31, 12},
        {-12, 23}, {10, 12}, {15, 13}, {20, 12}, {26, 6}, {36, 7}, {28, 6}, {-14, 18},
        {19, 14}, {16, 18}, {58, 6}, {82, -3}, {48, 10}, {63, -2}, {17, 16}, {24, 7},
        {70, -11}, {61, -2}, {58, -1}, {52, 0}, {32, 8}, {20, 14}, {37, 8}, {45, 4},
    },
    {
        {-18, -104}, {-8, -125}, {-6, -126}, {-2, -111}, {-10, -132}, {-14, -177}, {-12, -165}, {-8, -144},
        {-14, -110}, {-8, -91}, {4, -95}, {-2, -83}, {4, -97}, {17, -119}, {21, -154}, {-24, -111},
        {-17, -76}, {-8, -70}, {-22, -34}, {-23, -43}, {-21, -31}, {-12, -40}, {5, -59}, {-13, -74},
        {-18, -73}, {-36, -28}, {-34, -12}, {-42, 21}, {-34, 7}, {-26, 3}, {-10, -23}, {-25, -16},
        {-32, -43}, {-39, -13}, {-44, 17}, {-40, 35}, {-38, 49}, {-32, 41}, {-20, 27}, {-7, -8},
        {-37, -40}, {-29, -20}, {-39, 13}, {-22, 31}, {-12, 50}, {13, 53}, {3, 35}, {-13, 31},
        {-60, -12}, {-65, 6}, {-28, 24}, {-32, 35}, {-43, 57}, {8, 27}, {-26, 35}, {-16, 15},
        {-28, -17}, {27, -28}, {27, -14}, {19, 8}, {15, 23}, {71, -16}, {71, -27}, {40, -14},
    },
    {
        {-6, -41}, {45, -46}, {16, -37}, {-66, -9}, {-31, -34}, {-20, -20}, {43, -43}, {59, -72},
        {68, -51}, {12, -7}, {-19, 15}, {-64, 23}, {-63, 25}, {-18, 15}, {7, -2}, {52, -38},
        {-53, -2}, {-12, 5}, {-27, 20}, {-31, 22}, {-34, 25}, {-42, 26}, {-35, 14}, {-87, 15},
        {-30, 7}, {36, 6}, {11, 25}, {8, 28}, {-16, 33}, {-21, 29}, {-14, 16}, {-92, 19},
        {32, -12}, {93, -7}, {155, -1}, {139, 11}, {126, 12}, {78, 19}, {39, 7}, {-46, 5},
        {50, 13}, {190, -8}, {261, -6}, {261, -8}, {256, -2}, {235, 0}, {124, 15}, {54, 10},
        {51, -25}, {204, -35}, {257, -24}, {255, -13}, {236, -12}, {185, -5}, {110, -6}, {30, -19},
        {129, -59}, {248, -52}, {214, -25}, {185, -5}, {144, 7}, {199, -17}, {89, -16}, {-83, -8},
    },
};
...
{
    {
        {-14, -2}, {5, 12}, {69, -37}, {58, -52}, {-49, 110}, {7, 14}, {39, 19}, {47, 29},
        {-91, 53}, {11, 18}, {26, 35}, {90, -61}, {146, -92}, {-10, 43}, {-1, 2},
    },
    {
        {3, -3}, {12, -3}, {13, -24}, {1, -34}, {-1, 83}, {6, -7}, {28, 10}, {19, 30},
        {-37, 58}, {8, 10}, {9, 43}, {1, -31}, {16, -39}, {6, 35}, {10, -11},
    },
    {
        {0, 4}, {12, -6}, {-3, -15}, {-8, -25}, {30, 63}, {-9, -14}, {26, 18}, {23, 31},
        {-7, 54}, {14, 10}, {24, 28}, {-11, -17}, {-16, -14}, {13, 31}, {-7, -7},
    },
    {
        {-2, 11}, {6, 5}, {-12, -14}, {-20, -1}, {27, 77}, {-5, -32}, {16, 45}, {29, 38},
        {7, 46}, {11, 23}, {19, 39}, {-24, 19}, {-16, -3}, {8, 34}, {-8, -7},
    },
};
...
{
    {-14, -77}, {-10, -5}, {-8, 9}, {-4, 11}, {-2, 7}, {-1, 7}, {-1, 2}, {-1, -5},
    {1, -13}, {-9, -90}, {-9, -37}, {-2, -30}, {-4, -7}, {-2, 1}, {1, 9}, {2, 11},
    {0, 12}, {-3, 14}, {-3, 7}, {-1, -1}, {3, -7}, {-1, -2}, {9, -17}, {-14, -155},
    {-9, -92}, {-6, -60}, {-6, -25}, {-8, -2}, {-6, 6}, {-4, 9}, {1, 9}, {-1, 19},
    {0, 23}, {2, 24}, {4, 23}, {9, 17}, {19, 12}, {28, 2}, {4, -188}, {9, -149},
    {6, -118}, {4, -97}, {2, -74}, {0, -55}, {-1, -42}, {-3, -27}, {-2, -23}, {-3, -12},
    {-4, -2}, {-4, 3}, {-6, 11}, {-7, 17}, {-7, 18}, {-8, 23}, {-9, 22}, {-9, 21},
    {-9, 21}, {-8, 18}, {-11, 17}, {-6, 13}, {-6, 8}, {-4, 5}, {7, -8}, {-3, -4},
    {-29, -2}, {-24, 0},
};
...
{
    {{-71, 17}, {-24, 13}, {14, -3}, {41, -18}},
    {{-67, -109}, {-13, 66}, {-270, 246}, {-136, 338}},
    {{-24, -8}, {-10, -10}, {6, -15}, {18, -15}},
    {{14, -27}, {-28, 5}, {-66, 41}, {-181, 76}},
    {{-1, 3}, {-5, 12}, {3, 4}, {8, -13}},
    {{13, -36}, {2, -20}, {-78, 20}, {-78, 0}},
    {{0, -2}, {2, -2}, {5, -3}, {8, -9}},
    {{18, -14}, {-11, 2}, {-103, 32}, {-290, 84}},
    {{-39, -6}, {-19, -4}, {5, -11}, {33, -13}},
    {{-66, -111}, {-86, 46}, {-320, 177}, {-191, 219}},
    {{-14, -5}, {-10, -2}, {4, -1}, {15, 4}},
    {{15, -23}, {-18, 8}, {-61, 39}, {-113, 72}},
    {{1, 4}, {0, 0}, {-2, -10}, {-2, -30}},
    {{14, -37}, {12, -19}, {-95, 67}, {-88, 34}},
    {{1, -6}, {0, -11}, {0, -17}, {-2, -24}},
    {{21, -10}, {-2, 8}, {-77, 41}, {-214, 92}},
    {{23, -46}, {-18, 1}, {-2, 9}, {8, 20}},
    {{-56, -105}, {-65, -43}, {-220, 68}, {-281, 174}},
    {{-11, -19}, {-10, -5}, {1, 0}, {-3, 11}},
    {{23, -25}, {-26, -6}, {-70, 9}, {-62, -24}},
    {{9, 0}, {-16, 12}, {-26, 14}, {-9, -48}},
    {{13, -31}, {-17, -1}, {-63, 62}, {-117, -32}},
    {{-6, -8}, {-10, -5}, {-15, -3}, {-19, 2}},
    {{25, -16}, {-26, 12}, {-110, 44}, {-256, 99}},
    {{-2, -43}, {-30, -7}, {-10, 5}, {26, 3}},
    {{-50, -112}, {-80, -32}, {-163, 57}, {-177, 115}},
    {{9, -26}, {-10, -4}, {-1, 6}, {11, 10}},
    {{14, -13}, {-19, 4}, {-53, 18}, {-76, 24}},
    {{7, 4}, {-10, 10}, {-33, 15}, {-57, 13}},
    {{17, -37}, {-18, 0}, {-102, 87}, {-75, 19}},
    {{12, -8}, {-5, -1}, {-16, 1}, {-29, -1}},
    {{22, -16}, {-10, 7}, {-59, 37}, {-187, 100}},
    {{8, -63}, {-53, 22}, {-63, 59}, {-104, 130}},
    {{-41, -89}, {-63, -29}, {-97, 24}, {-112, 68}},
    {{19, -57}, {-68, 11}, {-104, 55}, {-10, 30}},
    {{16, -21}, {-14, 5}, {-94, 37}, {-87, 4}},
    {{-13, 8}, {-2, 13}, {-27, 16}, {12, -1}},
    {{18, -38}, {-43, -13}, {-172, 103}, {-15, 45}},
    {{-30, 9}, {42, -18}, {25, -13}, {0, -13}},
    {{38, -10}, {-25, 6}, {-77, 19}, {-264, 98}},
    {{-25, -55}, {-82, 13}, {-83, 47}, {-48, 73}},
    {{-54, -86}, {-77, -38}, {-64, -10}, {-123, 47}},
    {{43, -56}, {-44, 4}, {-84, 49}, {-63, 64}},
    {{-1, -13}, {-7, 1}, {-31, 19}, {-96, 54}},
    {{-27, 10}, {22, -7}, {60, -26}, {13, -3}},
    {{11, -32}, {-63, 9}, {-209, 132}, {-75, 7}},
    {{-49, 8}, {12, -17}, {41, -31}, {4, -18}},
    {{20, -16}, {-45, 14}, {-50, 19}, {-208, 98}},
    {{-12, -66}, {-4, 56}, {-45, 259}, {200, 304}},
    {{-46, -82}, {-92, -30}, {-184, 37}, {-284, 131}},
    {{48, -54}, {-108, 93}, {-70, 133}, {76, 139}},
    {{42, -24}, {-51, 45}, {-93, 83}, {-37, 75}},
    {{-16, -15}, {-17, -7}, {-30, -25}, {72, 12}},
    {{36, -39}, {-117, 51}, {-155, 63}, {-22, 52}},
    {{-24, 10}, {-21, 12}, {5, -13}, {12, -21}},
    {{82, -5}, {-75, 28}, {-161, 40}, {-287, 79}},
    {{-49, -62}, {-36, 34}, {12, 277}, {150, 261}},
    {{-43, -69}, {-73, -31}, {-93, -1}, {-266, 68}},
    {{44, -64}, {-119, 65}, {-120, 100}, {12, 76}},
    {{15, -2}, {5, 23}, {-74, 78}, {-8, 65}},
    {{-21, -2}, {0, -8}, {-23, -13}, {59, -34}},
    {{17, -54}, {-29, -10}, {-184, 85}, {-35, 42}},
    {{-26, 5}, {22, -18}, {-3, -20}, {50, -3}},
    {{63, -18}, {-12, 3}, {-36, 6}, {-241, 80}},
};
...
{
    {
        {53, 80}, {39, 70}, {23, -6}, {10, 25}, {-12, -3}, {33, 28}, {-4, -8}, {5, 13},
        {-6, -43}, {-6, -41}, {44, 52}, {8, 59}, {10, 17}, {5, 72}, {-68, -10}, {-52, 8},
        {-56, 12}, {-7, 45}, {-10, 55}, {16, 108}, {-53, -1}, {1, 29}, {-11, 71}, {20, 97},
    },
    {
        {55, 53}, {38, 50}, {19, -9}, {12, 17}, {-13, -2}, {35, 22}, {-3, -5}, {-1, 13},
        {-9, -35}, {-12, -29}, {42, 31}, {10, 60}, {-3, 22}, {19, 60}, {-38, -19}, {-65, 16},
        {10, 2}, {-2, -22}, {39, 55}, {27, 6}, {12, -4}, {-29, -24}, {28, 84}, {17, 8},
    },
    {
        {55, 79}, {37, 67}, {23, -4}, {13, 25}, {-12, -2}, {35, 34}, {-6, -8}, {2, 25},
        {-9, -48}, {-9, -43}, {47, 50}, {4, 54}, {9, 17}, {6, 69}, {-58, -24}, {-50, 3},
        {-55, 10}, {-6, 48}, {-9, 55}, {17, 110}, {-53, 1}, {1, 28}, {-10, 69}, {22, 96},
    },
    {
        {56, 49}, {38, 47}, {22, -8}, {14, 17}, {-12, -3}, {34, 24}, {-4, -6}, {2, 23},
        {-10, -38}, {-14, -34}, {41, 36}, {8, 54}, {0, 20}, {15, 58}, {-15, -56}, {-59, 21},
        {7, 4}, {-4, -21}, {40, 54}, {23, 6}, {12, -3}, {-20, -30}, {29, 81}, {14, 1},
    },
    {
        {54, 59}, {11, 77}, {58, -24}, {16, 20}, {-11, 0}, {38, 20}, {-1, -6}, {29, 1},
        {-27, -27}, {-28, -21}, {59, 19}, {-13, 69}, {-3, 28}, {65, 36}, {-111, 19}, {-48, 14},
        {6, 2}, {10, -14}, {51, 49}, {28, 39}, {1, 4}, {-10, -25}, {31, 77}, {-6, 63},
    },
    {
        {48, 51}, {29, 69}, {53, -24}, {11, 20}, {-21, 7}, {28, 23}, {3, -7}, {28, -2},
        {-9, -31}, {-21, -18}, {60, 6}, {-15, 70}, {0, 26}, {57, 34}, {-100, 16}, {-36, 14},
        {20, 2}, {-59, -41}, {50, 55}, {-21, -43}, {19, 4}, {-128, -33}, {45, 79}, {-56, -33},
    },
    {
        {32, 74}, {33, 115}, {68, -19}, {18, 7}, {12, -6}, {35, 16}, {3, 4}, {69, -15},
        {10, -36}, {14, -45}, {30, 37}, {11, 51}, {-11, 45}, {30, 37}, {-128, 25}, {-4, -10},
        {3, -16}, {-32, -57}, {3, 55}, {-39, 40}, {-17, 6}, {-25, -48}, {4, 76}, {-39, 45},
    },
    {
        {8, 70}, {22, 118}, {90, -28}, {25, -1}, {-5, 3}, {32, 21}, {-2, -2}, {46, -3},
        {12, -38}, {24, -47}, {19, 13}, {24, 56}, {-10, 47}, {45, 23}, {-107, 20}, {-7, -2},
        {9, -11}, {-155, -49}, {45, 32}, {-15, -10}, {15, -4}, {-179, -42}, {68, 51}, {-17, -18},
    },
    {
        {19, 134}, {3, 120}, {79, -25}, {26, -5}, {27, -8}, {16, 26}, {21, -7}, {23, 6},
        {9, -40}, {21, -48}, {16, 30}, {2, 48}, {-22, 56}, {13, 63}, {-102, 15}, {1, -27},
        {2, -44}, {-6, -58}, {-15, 33}, {42, 98}, {-23, -1}, {8, -55}, {-7, 63}, {60, 109},
    },
    {
        {24, 111}, {0, 118}, {69, -19}, {4, -4}, {13, 0}, {51, 32}, {7, 0}, {17, 14},
        {23, -59}, {38, -69}, {30, 32}, {4, 31}, {10, 57}, {48, 57}, {-90, 10}, {-8, -17},
        {8, -17}, {-28, -49}, {14, 38}, {19, 43}, {0, 2}, {-62, -26}, {27, 62}, {7, 12},
    },
};
...
{
    {
        {27, -19}, {12, 4}, {-10, 6}, {-6, -1}, {-15, -16}, {-9, -17}, {-11, -9}, {2, -5},
        {31, -13}, {-1, -15}, {-9, -3}, {-9, 2}, {7, -11}, {1, -17}, {-17, -11}, {-5, -5},
        {28, -21}, {4, -17}, {-6, -13}, {1, -14}, {-1, -13}, {-4, -23}, {-2, -30}, {3, -15},
        {0, 3}, {-8, -7}, {4, -14}, {12, -35}, {11, -37}, {6, -32}, {-6, -28}, {-1, -22},
        {0, 25}, {-10, 13}, {15, -27}, {45, -45}, {32, -43}, {3, -44}, {29, -45}, {-8, -14},
        {-1, 46}, {15, 17}, {24, -2}, {31, -21}, {4, -28}, {-3, -38}, {-22, -13}, {-25, 0},
    },
    {
        {11, -15}, {18, 3}, {4, 4}, {-9, -1}, {2, -26}, {-13, -15}, {-10, -5}, {0, 0},
        {14, -10}, {24, -11}, {-9, 8}, {-12, 3}, {-5, 1}, {-1, -8}, {-16, -3}, {-3, 0},
        {21, -6}, {21, -10}, {0, -3}, {-4, 0}, {-9, -5}, {-7, -12}, {-1, -20}, {0, -8},
        {2, 0}, {2, -6}, {6, -12}, {-4, -18}, {3, -28}, {3, -28}, {-1, -28}, {1, -18},
        {1, 23}, {-17, 20}, {-2, -10}, {5, -28}, {8, -40}, {-3, -41}, {7, -35}, {-4, -9},
        {-15, 13}, {-23, 15}, {-1, -5}, {0, -24}, {-3, -32}, {-23, -26}, {-12, -27}, {-39, 2},
    },
    {
        {1, -12}, {2, -10}, {28, -7}, {-4, 3}, {-10, -12}, {-3, -9}, {-7, -2}, {-2, -1},
        {-5, -7}, {9, -8}, {18, -6}, {1, -4}, {-6, -10}, {5, -5}, {-15, 5}, {-9, -1},
        {5, -5}, {9, -4}, {16, -7}, {8, -7}, {-1, -13}, {0, -12}, {-5, -15}, {-7, -5},
        {-1, -6}, {-2, -12}, {25, -20}, {10, -26}, {5, -31}, {4, -29}, {-8, -21}, {-13, -12},
        {-10, 5}, {-22, 2}, {-31, -9}, {2, -31}, {-6, -33}, {-16, -39}, {-9, -33}, {-8, -15},
        {5, -14}, {-23, -17}, {-34, 12}, {-12, -22}, {-10, -39}, {-27, -38}, {-25, -31}, {-7, -36},
    },
    {
        {5, -4}, {2, -9}, {3, -14}, {16, 8}, {-3, 2}, {-3, -10}, {6, 1}, {1, 2},
        {-7, 5}, {-9, -3}, {6, 10}, {22, -4}, {2, 1}, {-4, -4}, {-8, 7}, {-2, 3},
        {-8, 4}, {-8, 3}, {8, 2}, {12, -4}, {7, -4}, {1, -9}, {-1, -8}, {-8, -5},
        {-14, 4}, {-12, -4}, {2, -8}, {-1, -19}, {-1, -24}, {1, -21}, {0, -25}, {-11, -10},
        {-20, 12}, {-44, 4}, {-62, 10}, {-58, 0}, {-26, -19}, {-39, -18}, {-24, -22}, {-14, -3},
        {-32, -10}, {-31, -9}, {-38, -9}, {-48, 12}, {-26, -24}, {-58, -15}, {-58, -25}, {-27, -16},
    },
    {
        {23, -19}, {16, 5}, {-3, 2}, {-7, 0}, {-18, -12}, {-13, -16}, {-12, -8}, {0, -6},
        {19, -14}, {-5, -8}, {-6, -2}, {-5, 4}, {4, -11}, {0, -13}, {-17, -9}, {-7, 1},
        {25, -6}, {-8, -4}, {-8, -6}, {4, -8}, {-5, -9}, {-6, -22}, {0, -27}, {2, -18},
        {6, 10}, {-4, 2}, {3, -8}, {17, -28}, {16, -31}, {7, -32}, {-9, -27}, {-1, -22},
        {5, 31}, {-8, 15}, {16, -22}, {43, -45}, {31, -51}, {3, -48}, {28, -49}, {-8, -18},
        {-1, 51}, {17, 19}, {23, 0}, {29, -24}, {7, -26}, {0, -38}, {-21, -14}, {-28, -6},
    },
    {
        {2, -15}, {17, 2}, {9, 5}, {-7, -2}, {-8, -17}, {-15, -7}, {-10, -4}, {-2, 0},
        {7, -9}, {22, -13}, {-3, 10}, {-12, 2}, {-5, 5}, {-1, -8}, {-16, 2}, {-6, 3},
        {14, -10}, {20, -9}, {-3, 4}, {-5, 0}, {-1, -3}, {-8, -9}, {-2, -21}, {0, -7},
        {7, 2}, {6, 1}, {7, -1}, {4, -13}, {10, -26}, {3, -28}, {-2, -27}, {-1, -19},
        {3, 18}, {-16, 21}, {-1, -11}, {10, -30}, {13, -39}, {0, -41}, {6, -42}, {-1, -16},
        {-16, 10}, {-22, 21}, {-3, -5}, {3, -22}, {-5, -36}, {-18, -25}, {-11, -36}, {-40, -1},
    },
    {
        {1, -13}, {3, -9}, {29, -8}, {-2, 2}, {-10, -15}, {-5, -11}, {-9, 2}, {-4, -3},
        {-5, -11}, {2, -11}, {19, -2}, {4, -3}, {-5, -6}, {6, -5}, {-12, 4}, {-8, 4},
        {5, -8}, {3, -5}, {18, -5}, {5, -6}, {-3, -8}, {-1, -9}, {-4, -11}, {-7, -7},
        {-4, -6}, {6, -4}, {26, -16}, {13, -15}, {8, -23}, {7, -28}, {-7, -21}, {-13, -10},
        {-16, 7}, {-19, 5}, {-26, -8}, {2, -30}, {-1, -30}, {-17, -38}, {-8, -38}, {-9, -20},
        {7, -17}, {-21, -16}, {-32, 12}, {-11, -23}, {-9, -36}, {-24, -43}, {-25, -30}, {-11, -41},
    },
    {
        {1, -1}, {-2, -10}, {4, -4}, {18, 4}, {1, 3}, {-4, -15}, {-3, 2}, {-5, 4},
        {-3, 5}, {-8, -3}, {7, -1}, {24, 0}, {1, -3}, {-2, -2}, {-8, 11}, {-2, 1},
        {-5, 2}, {-5, -3}, {10, 2}, {15, 6}, {6, -4}, {-10, -3}, {4, -9}, {-5, 5},
        {-11, 0}, {-10, -1}, {6, -2}, {3, 2}, {3, -9}, {6, -17}, {-2, -19}, {-11, -11},
        {-17, 0}, {-45, 5}, {-62, 10}, {-44, 2}, {-24, -20}, {-34, -20}, {-26, -23}, {-12, -10},
        {-32, -12}, {-30, -7}, {-36, -10}, {-45, 10}, {-21, -28}, {-55, -17}, {-55, -25}, {-25, -20},
    },
    {
        {-6, -18}, {-11, 4}, {-6, -6}, {-20, 0}, {-24, -5}, {-15, -13}, {-11, -9}, {-1, -6},
        {-4, 3}, {27, -1}, {10, 5}, {1, 7}, {26, -7}, {9, -13}, {-15, 0}, {-7, -5},
        {14, -19}, {2, -10}, {-10, 11}, {8, 4}, {13, -10}, {-3, -18}, {-7, -25}, {1, -14},
        {21, -2}, {-6, 10}, {0, 8}, {26, -15}, {10, -23}, {-2, -24}, {-3, -26}, {-5, -29},
        {28, 10}, {19, 17}, {16, 4}, {22, -24}, {13, -39}, {-5, -47}, {2, -57}, {-2, -39},
        {16, 31}, {-4, 42}, {15, -6}, {2, -14}, {3, -45}, {-3, -51}, {-21, -49}, {3, -44},
    },
    {
        {-7, -14}, {-9, -11}, {-7, -7}, {-10, -10}, {-12, -1}, {-9, -6}, {-8, 3}, {-5, 2},
        {-2, -6}, {-19, 19}, {20, -5}, {7, -5}, {-6, 2}, {7, -7}, {-10, 0}, {-7, 3},
        {10, -2}, {8, -6}, {-15, 11}, {-14, 14}, {0, 3}, {-6, -6}, {-8, -11}, {-7, -3},
        {10, -5}, {7, 6}, {-4, 14}, {5, -7}, {9, -13}, {0, -23}, {-5, -22}, {-5, -16},
        {36, 3}, {50, 12}, {23, 5}, {30, -18}, {4, -37}, {6, -54}, {-9, -38}, {22, -42},
        {33, -5}, {-22, 46}, {32, 9}, {4, -22}, {6, -61}, {-4, -59}, {4, -52}, {-1, -44},
    },
    {
        {-11, -9}, {-15, -10}, {3, -21}, {1, -15}, {-7, -19}, {1, -7}, {3, 1}, {-13, 17},
        {-16, 4}, {-17, -3}, {5, -1}, {23, -6}, {3, -2}, {10, -3}, {6, 2}, {-8, 7},
        {-11, -1}, {-10, -7}, {16, -7}, {-4, 6}, {0, 1}, {-3, 9}, {-2, -5}, {-2, 5},
        {-13, -5}, {7, -4}, {7, 6}, {-5, 3}, {-1, -10}, {-5, -6}, {-3, -9}, {-2, -13},
        {34, -16}, {17, 4}, {14, 1}, {9, -3}, {9, -23}, {-11, -35}, {7, -34}, {8, -24},
        {47, -29}, {-1, -5}, {2, 4}, {4, -12}, {-12, -42}, {-18, -50}, {-10, -57}, {24, -46},
    },
    {
        {-10, 14}, {-13, -6}, {1, -20}, {-4, -24}, {-10, -22}, {-8, -16}, {-15, 13}, {-16, 21},
        {-1, 6}, {-16, 4}, {20, -13}, {-1, 1}, {19, -12}, {8, -12}, {-10, 7}, {-9, 17},
        {2, 15}, {-8, 0}, {-2, -3}, {20, -6}, {0, -2}, {-12, 2}, {-9, 11}, {0, 3},
        {1, 2}, {-10, 0}, {6, -1}, {0, 10}, {-1, 1}, {-15, -8}, {-12, 0}, {7, -9},
        {21, -3}, {-5, -2}, {12, -4}, {20, -3}, {18, -8}, {12, -29}, {0, -26}, {15, -27},
        {20, -32}, {-6, -27}, {13, -20}, {5, -7}, {5, -24}, {0, -41}, {2, -57}, {9, -43},
    },
    {
        {-6, -15}, {-12, 7}, {-9, -13}, {-21, 1}, {-24, -10}, {-17, -15}, {-8, -5}, {0, -7},
        {-3, 3}, {21, -5}, {7, 2}, {2, 12}, {27, -5}, {5, -14}, {-9, -1}, {-6, 0},
        {11, -17}, {6, 4}, {-7, 17}, {8, 6}, {14, -7}, {-2, -16}, {-7, -19}, {-1, -13},
        {16, -11}, {-13, 8}, {2, 17}, {27, -9}, {13, -19}, {0, -26}, {-5, -23}, {-2, -26},
        {27, 18}, {18, 17}, {16, 4}, {25, -20}, {13, -40}, {-7, -52}, {1, -56}, {-1, -39},
        {21, 38}, {-4, 35}, {18, -2}, {2, -16}, {4, -45}, {-9, -56}, {-20, -48}, {1, -46},
    },
    {
        {-9, -14}, {-9, -13}, {-8, -8}, {-10, -11}, {-13, -2}, {-12, -2}, {-9, 3}, {-7, 3},
        {-4, -14}, {-20, 16}, {19, -11}, {3, -1}, {-7, 7}, {8, -6}, {-9, 4}, {-10, 3},
        {9, 3}, {9, -7}, {-13, 18}, {-10, 17}, {0, 5}, {-7, 4}, {-9, -13}, {-3, 0},
        {8, 2}, {6, 7}, {-3, 13}, {6, 1}, {12, -4}, {-2, -19}, {-7, -20}, {-5, -18},
        {34, 3}, {53, 11}, {26, 12}, {30, -20}, {3, -35}, {8, -51}, {-9, -44}, {20, -41},
        {34, -4}, {-17, 52}, {26, 4}, {3, -23}, {7, -63}, {-2, -56}, {5, -54}, {-3, -49},
    },
    {
        {-15, -10}, {-18, -5}, {-3, -21}, {-1, -18}, {-9, -23}, {-1, -8}, {-2, 5}, {-18, 15},
        {-27, 3}, {-18, -6}, {5, -3}, {16, -13}, {1, -1}, {11, 2}, {3, 4}, {-8, 12},
        {-7, 6}, {-9, -6}, {15, -6}, {-3, 13}, {1, 9}, {-5, 11}, {-1, -1}, {-4, 2},
        {-13, -1}, {5, -8}, {9, 8}, {-9, 7}, {0, 1}, {-2, -2}, {-5, -11}, {0, -9},
        {36, -16}, {18, 8}, {21, 8}, {12, 0}, {11, -25}, {-10, -36}, {4, -37}, {5, -29},
        {50, -27}, {-2, -2}, {5, 11}, {1, -13}, {-13, -44}, {-20, -53}, {-10, -57}, {17, -53},
    },
    {
        {-13, 14}, {-15, -10}, {-1, -18}, {-4, -26}, {-9, -23}, {-11, -18}, {-16, 13}, {-20, 22},
        {-1, 17}, {-18, 3}, {15, -16}, {-1, -1}, {16, -17}, {6, -9}, {-8, 11}, {-8, 14},
        {-4, 14}, {-8, 5}, {-1, 2}, {20, -7}, {3, 8}, {-9, 5}, {-11, 0}, {-3, 14},
        {5, 7}, {-11, 0}, {-2, -2}, {-2, 11}, {-6, -1}, {-13, 1}, {-12, 3}, {3, -12},
        {19, -7}, {-6, -6}, {11, -1}, {25, -2}, {21, -4}, {12, -32}, {4, -24}, {18, -28},
        {16, -37}, {-2, -24}, {15, -21}, {7, -6}, {8, -24}, {-2, -45}, {-1, -62}, {8, -37},
    },
    {
        {-17, 47}, {-33, 30}, {-27, 6}, {-19, -4}, {-18, -18}, {-37, 4}, {-32, 21}, {-6, 10},
        {-4, 20}, {-7, 11}, {-8, -13}, {-23, 12}, {-12, 1}, {-25, -1}, {-24, 10}, {-7, 5},
        {10, 7}, {-15, 11}, {-5, 4}, {-5, 27}, {-5, 7}, {-13, 4}, {-14, -10}, {-4, -7},
        {-3, 0}, {-5, 38}, {49, 9}, {0, 26}, {13, -5}, {-7, -11}, {-16, -12}, {-23, -9},
        {9, 5}, {14, 25}, {19, 17}, {35, -3}, {-7, -22}, {-15, -43}, {-7, -45}, {-6, -30},
        {15, 16}, {11, 24}, {21, 22}, {3, 11}, {-29, -43}, {-38, -54}, {-25, -47}, {2, -61},
    },
    {
        {-28, 35}, {-50, 42}, {-12, 18}, {4, -9}, {-15, -15}, {-35, 9}, {-19, 18}, {-3, 18},
        {-29, 8}, {-22, 10}, {-13, 1}, {-16, -11}, {2, 8}, {-4, 0}, {-20, 12}, {9, 6},
        {-6, 13}, {-32, 19}, {-18, 17}, {-5, -5}, {-13, 22}, {-6, 4}, {-4, -9}, {4, -5},
        {21, 12}, {-16, 49}, {14, 34}, {8, -9}, {8, 3}, {-7, -3}, {-12, -3}, {-14, -10},
        {43, -8}, {17, 15}, {16, 7}, {31, 4}, {1, -6}, {-17, -29}, {-7, -46}, {-8, -36},
        {31, 14}, {12, 13}, {24, 38}, {-3, 4}, {-16, -13}, {-32, -45}, {-24, -52}, {0, -61},
    },
    {
        {-20, 23}, {-35, 25}, {-26, 27}, {-10, 8}, {-8, -8}, {-14, 1}, {-17, 19}, {-14, 18},
        {-43, 8}, {-19, 2}, {-23, 14}, {0, -6}, {-29, -3}, {-5, 1}, {-5, 9}, {-4, 6},
        {-21, 8}, {-15, -5}, {-7, 25}, {-9, 12}, {-14, 6}, {-6, 22}, {-10, 2}, {-5, 6},
        {-1, 1}, {-7, 16}, {-12, 65}, {-10, 33}, {10, -3}, {1, 10}, {9, -3}, {9, -12},
        {27, 6}, {18, 4}, {22, 27}, {1, 15}, {5, 7}, {1, -8}, {-4, -32}, {-5, -20},
        {23, -29}, {20, 1}, {22, 17}, {12, 22}, {-9, -5}, {-26, -24}, {-22, -55}, {-20, -53},
    },
    {
        {-29, 28}, {-37, 23}, {-30, 13}, {-13, 8}, {-11, -3}, {-23, 0}, {-37, 25}, {-14, 23},
        {-39, 34}, {-32, -9}, {0, -9}, {-9, 2}, {-15, -1}, {-19, -14}, {-33, 17}, {-20, 28},
        {-27, 35}, {-17, -7}, {-18, 12}, {-14, 26}, {-8, 6}, {-1, -5}, {-26, 17}, {-4, 12},
        {-22, 24}, {15, -5}, {-4, 25}, {2, 55}, {-1, 16}, {-2, -2}, {-4, 9}, {-5, 0},
        {31, 1}, {8, 10}, {6, 12}, {22, 33}, {14, 7}, {5, 0}, {-8, -7}, {12, -19},
        {12, -17}, {-4, -23}, {17, 7}, {27, 26}, {4, 15}, {-21, -15}, {-21, -23}, {-12, -40},
    },
    {
        {-17, 49}, {-30, 29}, {-28, 6}, {-22, -8}, {-16, -16}, {-35, 6}, {-34, 20}, {-7, 11},
        {2, 31}, {-4, 18}, {-5, -2}, {-23, 13}, {-17, 3}, {-28, -2}, {-23, 9}, {-8, 3},
        {14, 12}, {-10, 18}, {-5, 4}, {-9, 22}, {-5, 10}, {-14, 4}, {-13, -14}, {0, -7},
        {-3, 0}, {-9, 35}, {50, 12}, {0, 23}, {16, -5}, {-11, -12}, {-14, -10}, {-26, -15},
        {8, 3}, {17, 36}, {21, 19}, {35, -7}, {-7, -23}, {-15, -42}, {-10, -50}, {-8, -35},
        {16, 21}, {12, 26}, {26, 27}, {5, 11}, {-32, -42}, {-38, -50}, {-23, -45}, {4, -60},
    },
    {
        {-28, 33}, {-49, 42}, {-15, 13}, {5, -13}, {-16, -13}, {-38, 6}, {-17, 21}, {-9, 13},
        {-25, 26}, {-12, 31}, {-10, 7}, {-13, -7}, {0, 7}, {-7, -3}, {-24, 4}, {5, 4},
        {-5, 14}, {-29, 22}, {-17, 18}, {-8, -9}, {-14, 18}, {-9, 0}, {-5, -13}, {2, -9},
        {20, 14}, {-17, 46}, {13, 29}, {12, -3}, {6, 0}, {-5, -3}, {-14, -6}, {-13, -12},
        {46, 24}, {18, 17}, {23, 43}, {29, 5}, {-3, -7}, {-18, -32}, {-6, -46}, {-12, -40},
        {29, 3}, {15, 16}, {18, 34}, {-1, 8}, {-13, -12}, {-36, -47}, {-26, -57}, {-2, -63},
    },
    {
        {-24, 19}, {-38, 21}, {-24, 27}, {-11, 7}, {-7, -8}, {-20, -2}, {-21, 17}, {-15, 20},
        {-39, 14}, {-15, 9}, {-18, 24}, {2, -3}, {-30, -3}, {-4, -2}, {-7, 5}, {-7, 5},
        {-18, -1}, {-11, 5}, {-9, 32}, {-7, 18}, {-17, 3}, {-8, 16}, {-12, -4}, {-5, 4},
        {1, 14}, {-6, 17}, {-14, 63}, {-14, 34}, {11, -1}, {-1, 11}, {6, -3}, {4, -18},
        {29, 8}, {23, 26}, {20, 26}, {8, 57}, {5, 6}, {2, -5}, {-6, -32}, {-10, -22},
        {28, -15}, {18, 1}, {25, 22}, {17, 26}, {-6, -1}, {-29, -29}, {-21, -53}, {-23, -57},
    },
    {
        {-27, 29}, {-39, 17}, {-32, 13}, {-16, 4}, {-10, -6}, {-20, 0}, {-39, 23}, {-14, 21},
        {-44, 30}, {-29, 8}, {5, 0}, {-5, 10}, {-15, 3}, {-16, -7}, {-35, 13}, {-20, 21},
        {-26, 38}, {-20, -12}, {-13, 15}, {-13, 24}, {-9, 12}, {-3, -11}, {-27, 13}, {-5, 7},
        {-20, 28}, {17, 0}, {-2, 28}, {-2, 54}, {-2, 14}, {-1, -1}, {-3, 12}, {-8, -1},
        {30, 1}, {6, 3}, {12, 34}, {18, 33}, {19, 36}, {4, 2}, {-12, -5}, {10, -21},
        {8, -23}, {2, -15}, {17, 7}, {32, 30}, {3, 17}, {-17, -9}, {-21, -26}, {-10, -40},
    },
    {
        {-2, 33}, {-8, 22}, {-24, 2}, {-11, -3}, {-35, -27}, {-22, 6}, {-14, 15}, {-17, 0},
        {-9, 44}, {-4, 32}, {7, 8}, {-9, 10}, {-9, -3}, {-13, -3}, {-21, 2}, {-11, 2},
        {5, 68}, {7, 51}, {4, 34}, {6, 26}, {-18, 14}, {-20, -6}, {4, -17}, {-6, -4},
        {6, 15}, {-16, 27}, {1, -23}, {21, 22}, {16, -9}, {-4, -18}, {-19, -17}, {-24, -20},
        {-20, -52}, {2, 23}, {4, 4}, {6, -5}, {-15, -32}, {-25, -50}, {1, -18}, {-18, -41},
        {-32, -115}, {16, 41}, {-3, 6}, {-15, 21}, {-13, -5}, {-46, -51}, {-41, -56}, {-13, -62},
    },
    {
        {-18, 25}, {-2, 24}, {-14, 5}, {-19, 9}, {-17, -23}, {-13, 7}, {-7, 12}, {1, 20},
        {-19, 28}, {-1, 40}, {1, 16}, {-2, 20}, {-12, 9}, {-14, 5}, {-13, 2}, {-14, 3},
        {0, 44}, {-19, 62}, {6, 38}, {12, 23}, {4, 5}, {-16, 12}, {-19, -3}, {-13, 0},
        {3, 14}, {-19, 28}, {11, 27}, {-13, -24}, {20, 5}, {-4, 0}, {-22, -6}, {-13, -13},
        {6, 15}, {-20, 13}, {12, 11}, {-3, -10}, {-8, -24}, {3, -22}, {-21, -64}, {-19, -37},
        {11, 15}, {-8, -3}, {24, 41}, {-3, -7}, {-15, 5}, {-50, -47}, {-23, -33}, {-15, -63},
    },
    {
        {-6, 13}, {-20, 11}, {-10, 7}, {-12, -3}, {-32, -30}, {-22, 6}, {-15, 13}, {-22, 10},
        {-14, 11}, {-21, 18}, {-4, 28}, {2, 4}, {-18, 6}, {-19, -5}, {-22, -5}, {-1, 6},
        {-36, 46}, {-5, 22}, {-4, 59}, {-9, 43}, {0, 24}, {2, 10}, {-19, -16}, {-10, -9},
        {1, -27}, {9, 21}, {7, 49}, {-6, 39}, {-19, -21}, {-8, 17}, {-3, -5}, {-15, -10},
        {16, -24}, {-23, 3}, {11, 39}, {-7, 34}, {-28, -8}, {-9, -29}, {-28, -47}, {-4, -47},
        {-5, -44}, {15, 0}, {7, 31}, {8, 45}, {-21, -29}, {-33, -20}, {-28, -35}, {-21, -68},
    },
    {
        {-6, 2}, {-21, -1}, {-8, 4}, {14, 2}, {-21, -18}, {-21, -11}, {-18, 6}, {-6, 8},
        {-6, 10}, {-18, 5}, {-15, 11}, {-5, 25}, {-24, 11}, {-23, 10}, {-12, 3}, {-2, 11},
        {-11, 17}, {-15, 14}, {0, 35}, {2, 54}, {5, 32}, {-8, 18}, {-12, -2}, {-6, -2},
        {-10, 21}, {7, -26}, {2, 28}, {-15, 47}, {-10, 8}, {-32, -25}, {-4, 14}, {-11, -9},
        {21, -27}, {-16, -27}, {12, 17}, {-12, 51}, {-3, 18}, {-14, -19}, {-25, -18}, {-16, -23},
        {-6, -25}, {-16, -63}, {4, 14}, {-1, 32}, {7, 38}, {-36, -42}, {-27, -18}, {-23, -50},
    },
    {
        {-7, 33}, {-10, 17}, {-21, 6}, {-10, -2}, {-35, -25}, {-19, 2}, {-13, 20}, {-16, 6},
        {-9, 42}, {-7, 26}, {7, 12}, {-10, 9}, {-7, -6}, {-17, -4}, {-24, -3}, {-16, -1},
        {4, 66}, {8, 52}, {-3, 33}, {8, 28}, {-18, 11}, {-22, -9}, {0, -25}, {-5, -3},
        {7, 19}, {-12, 29}, {7, -17}, {22, 26}, {15, -12}, {-4, -19}, {-19, -12}, {-25, -22},
        {-19, -47}, {3, 27}, {3, 3}, {5, -7}, {-15, -34}, {-23, -49}, {1, -19}, {-17, -40},
        {-33, -113}, {19, 42}, {-2, 8}, {-11, 23}, {-13, -6}, {-43, -48}, {-37, -53}, {-15, -62},
    },
    {
        {-21, 19}, {-7, 19}, {-19, 1}, {-17, 7}, {-21, -27}, {-10, 8}, {-8, 9}, {-3, 13},
        {-23, 21}, {0, 39}, {-1, 15}, {-3, 22}, {-11, 7}, {-16, 8}, {-14, -1}, {-14, 0},
        {3, 46}, {-18, 61}, {4, 37}, {12, 19}, {3, 3}, {-16, 12}, {-17, -3}, {-17, -6},
        {5, 22}, {-14, 36}, {15, 31}, {-9, -18}, {18, 5}, {-1, 5}, {-23, -3}, {-12, -12},
        {4, 11}, {-17, 21}, {16, 17}, {-3, -14}, {-5, -24}, {4, -19}, {-19, -61}, {-22, -36},
        {6, 10}, {-8, -4}, {22, 44}, {-3, -8}, {-15, 4}, {-48, -46}, {-28, -34}, {-16, -63},
    },
    {
        {-8, 7}, {-25, 6}, {-11, 2}, {-14, -4}, {-30, -31}, {-26, 7}, {-17, 10}, {-22, 9},
        {-17, 10}, {-25, 15}, {-4, 30}, {1, 3}, {-17, 4}, {-18, -2}, {-19, 0}, {-3, 4},
        {-35, 43}, {-1, 25}, {-2, 55}, {-12, 41}, {-1, 23}, {2, 10}, {-19, -18}, {-5, -2},
        {6, -19}, {14, 26}, {12, 63}, {-8, 41}, {-14, -16}, {-7, 14}, {1, -2}, {-18, -11},
        {14, -31}, {-18, 5}, {14, 47}, {-6, 35}, {-30, -13}, {-6, -22}, {-29, -46}, {-1, -43},
        {-4, -44}, {9, -7}, {6, 33}, {6, 41}, {-19, -27}, {-34, -22}, {-29, -39}, {-21, -61},
    },
    {
        {-7, 1}, {-21, -1}, {-10, 4}, {12, 0}, {-24, -21}, {-19, -10}, {-21, 9}, {-9, 6},
        {-11, 5}, {-17, 7}, {-16, 8}, {-4, 25}, {-26, 7}, {-25, 13}, {-15, 1}, {0, 13},
        {-5, 20}, {-15, 8}, {1, 37}, {2, 52}, {6, 27}, {-7, 13}, {-12, -2}, {-7, -5},
        {-11, 15}, {10, -20}, {3, 26}, {-12, 51}, {-9, 10}, {-27, -17}, {-7, 7}, {-9, -4},
        {21, -24}, {-16, -33}, {14, 23}, {-8, 57}, {-2, 23}, {-19, -20}, {-23, -18}, {-18, -28},
        {-7, -23}, {-12, -61}, {1, 11}, {-1, 35}, {6, 33}, {-37, -40}, {-26, -19}, {-24, -47},
    },
};
...
{
    {
        {-16, -34}, {-7, -17}, {-2, -30}, {-1, -24}, {9, -33}, {4, -37}, {-1, -64}, {-31, -32},
        {12, -6}, {-4, -4}, {-14, -17}, {-2, -24}, {-3, -21}, {-8, -30}, {14, -56}, {-4, -52},
        {3, -1}, {2, -13}, {-9, 8}, {-1, -6}, {-4, -10}, {-3, -16}, {-2, -22}, {-12, -32},
        {-5, 11}, {7, 1}, {-8, 8}, {1, 3}, {1, -4}, {0, -14}, {-3, -20}, {-4, -40},
        {12, -1}, {5, 10}, {13, 3}, {3, -9}, {16, -17}, {1, -17}, {3, -22}, {-8, -33},
        {9, -13}, {1, 1}, {27, -22}, {27, -25}, {10, -11}, {7, -28}, {-10, -18}, {-4, -21},
        {4, -12}, {3, -23}, {15, -19}, {24, -16}, {7, -14}, {-2, -26}, {-13, -9}, {-5, -25},
        {-14, -16}, {-5, 0}, {24, 0}, {-3, 0}, {12, -20}, {-7, -6}, {-14, 0}, {29, -11},
    },
    {
        {-1, -39}, {-7, -5}, {-3, -8}, {-1, -23}, {-3, -19}, {3, -21}, {4, -14}, {1, -45},
        {3, -4}, {-8, -7}, {-8, -5}, {-1, -10}, {6, -22}, {-6, -15}, {3, -30}, {3, -41},
        {-1, 2}, {8, -1}, {2, -8}, {-7, 3}, {-4, -3}, {0, -8}, {2, -12}, {5, -32},
        {-2, 2}, {-4, 6}, {-5, 14}, {-7, 9}, {-6, 3}, {-7, -1}, {-5, -2}, {6, -24},
        {5, 6}, {-4, 11}, {-5, 12}, {-2, 3}, {-2, 1}, {-6, 1}, {-3, -3}, {1, -9},
        {-9, 5}, {-4, 5}, {12, -11}, {14, -16}, {0, -3}, {-8, -3}, {0, -6}, {14, -9},
        {23, -26}, {10, -18}, {17, -24}, {13, -6}, {4, -9}, {2, -14}, {5, -13}, {10, -3},
        {-9, -15}, {-10, -3}, {13, -1}, {6, 1}, {21, -15}, {7, 0}, {-3, 4}, {25, 20},
    },
    {
        {1, -13}, {-16, 24}, {-16, 27}, {-11, 0}, {-12, 0}, {-15, -9}, {-17, -5}, {8, -59},
        {-5, -7}, {-11, 8}, {5, 16}, {-5, 3}, {-5, -11}, {-14, -13}, {-10, -20}, {-9, -21},
        {-6, -7}, {-8, 12}, {5, 4}, {-8, 2}, {-4, -5}, {-11, 2}, {-7, -8}, {-9, -18},
        {-6, 0}, {-12, 0}, {-4, 1}, {-9, -3}, {-10, 2}, {-13, -9}, {-7, -3}, {-9, -14},
        {-8, -6}, {-4, -1}, {-11, -6}, {3, -8}, {-5, -6}, {-12, -2}, {-12, -7}, {-16, -3},
        {-9, -22}, {-2, -7}, {-18, -6}, {-9, -9}, {-15, -4}, {-21, 2}, {-8, -4}, {-23, 6},
        {-11, -6}, {-11, -12}, {-18, -10}, {-25, 2}, {-12, -12}, {-23, -2}, {2, -13}, {-13, -4},
        {-17, -16}, {-39, -4}, {-12, -9}, {-23, -7}, {-12, -16}, {-22, 2}, {-3, -4}, {7, -22},
    },
    {
        {19, -27}, {-3, 13}, {-9, 16}, {-12, 31}, {1, 8}, {2, -11}, {-1, 6}, {12, -38},
        {-9, -30}, {-6, -3}, {-5, 18}, {2, 1}, {-6, 6}, {-8, -1}, {-4, -10}, {-9, -11},
        {-5, -2}, {-7, 17}, {-2, 5}, {-3, 14}, {-5, 11}, {-10, 10}, {-8, 2}, {0, -15},
        {-3, -15}, {-16, 8}, {-10, 7}, {-20, 16}, {-15, 7}, {-13, 11}, {-26, 9}, {-2, -12},
        {-4, -6}, {-13, 5}, {-15, 9}, {-15, 0}, {-18, 6}, {-32, 15}, {-6, -2}, {-14, 11},
        {-10, -9}, {-22, 9}, {-33, 15}, {-35, 9}, {-20, 6}, {-40, 12}, {-15, 5}, {-14, 1},
        {-28, 4}, {-26, 12}, {-13, 1}, {-58, 24}, {-45, 11}, {-13, 0}, {-2, -12}, {-14, -2},
        {-24, 1}, {-25, -10}, {-38, 3}, {-32, 6}, {-20, -5}, {-46, 9}, {-10, 12}, {-4, -21},
    },
    {
        {-23, -17}, {-25, -5}, {-20, 9}, {-26, -9}, {-34, -23}, {-33, -23}, {-58, -10}, {-47, -13},
        {-7, 9}, {-27, 14}, {-31, 13}, {-17, 2}, {-26, -10}, {-49, -15}, {-17, -32}, {-50, -23},
        {-23, 37}, {14, 8}, {2, -8}, {-5, -14}, {20, -30}, {-19, -14}, {-36, -13}, {-54, -3},
        {8, 2}, {-4, -8}, {20, -14}, {15, -11}, {7, -26}, {7, -24}, {5, -29}, {-56, -14},
        {-9, 23}, {12, -13}, {28, -13}, {29, -20}, {31, -24}, {8, -33}, {-26, -15}, {-45, -22},
        {-13, -6}, {9, 9}, {12, -5}, {5, -7}, {7, -16}, {-4, -18}, {-7, -12}, {-15, -30},
        {-8, 2}, {5, -2}, {-3, -4}, {6, -10}, {7, -5}, {-13, -7}, {-17, -21}, {-17, -11},
        {-11, 10}, {-7, -9}, {24, 0}, {-1, -1}, {9, -14}, {-5, -23}, {-26, -19}, {-7, 7},
    },
    {
        {3, 36}, {-3, 4}, {-22, 17}, {-8, 2}, {-15, 6}, {-26, -2}, {-72, 4}, {-47, -8},
        {-4, 26}, {-21, 11}, {-11, 16}, {-10, -5}, {-18, -4}, {-6, -8}, {-13, -26}, {-23, 0},
        {0, 24}, {1, 10}, {20, -10}, {-13, -5}, {-7, -12}, {-21, 0}, {-14, -15}, {-45, -11},
        {-5, 11}, {12, -9}, {-31, 4}, {4, -7}, {17, -21}, {5, -23}, {6, -21}, {-38, -4},
        {-2, 13}, {13, -6}, {11, -12}, {16, -16}, {31, -21}, {25, -26}, {-6, -25}, {-17, -6},
        {-12, 2}, {5, 8}, {17, -7}, {23, -12}, {-6, -10}, {-1, -20}, {-5, -14}, {-6, -14},
        {-6, 5}, {0, 3}, {-16, 9}, {10, 1}, {3, -6}, {-18, -2}, {-11, -3}, {-20, -2},
        {-38, -4}, {-3, -1}, {22, 4}, {-2, -8}, {2, -7}, {-7, -11}, {-23, 1}, {-3, 12},
    },
    {
        {-11, 50}, {-17, 17}, {-35, 27}, {-23, 14}, {-18, 16}, {-11, 5}, {-49, 16}, {-38, 11},
        {-9, 36}, {-9, 26}, {-13, 29}, {-6, 7}, {-6, -7}, {-21, 3}, {-1, 4}, {-29, -2},
        {-25, 21}, {-2, 17}, {-12, 8}, {14, -11}, {3, -12}, {-3, -9}, {-9, -11}, {-27, -2},
        {-13, 11}, {-16, 9}, {5, -14}, {-5, -6}, {28, -31}, {19, -24}, {-11, -9}, {-24, -4},
        {-18, 10}, {5, -11}, {38, -19}, {15, -17}, {13, -21}, {24, -25}, {-4, -14}, {-8, -2},
        {-5, -3}, {-15, 6}, {-6, -4}, {11, -6}, {6, -9}, {-12, -6}, {3, -9}, {-6, -9},
        {-24, 14}, {5, 8}, {-27, 8}, {-2, -1}, {-6, -2}, {1, 1}, {4, -3}, {-9, 5},
        {-32, -5}, {10, 4}, {26, -7}, {0, 5}, {3, -3}, {7, -6}, {8, -3}, {-7, 3},
    },
    {
        {-12, 36}, {0, 27}, {-20, 20}, {-13, 21}, {-7, 26}, {-10, 30}, {-43, 40}, {-41, 12},
        {-18, 22}, {-28, 23}, {-13, 21}, {2, 11}, {-2, 8}, {-19, 8}, {-11, 12}, {-9, 4},
        {-37, 16}, {-3, 2}, {6, 1}, {0, -3}, {11, -9}, {-1, 0}, {-19, 3}, {-18, 4},
        {-28, 19}, {-15, 1}, {1, -11}, {-11, -5}, {-6, -8}, {22, -22}, {0, -5}, {-13, 7},
        {-14, 8}, {4, -14}, {25, -24}, {22, -15}, {14, -16}, {30, -20}, {-2, -12}, {-21, 8},
        {-30, 8}, {-12, 9}, {-9, -1}, {4, 0}, {10, -8}, {-5, -6}, {-5, 0}, {-11, 0},
        {-20, 14}, {-7, 9}, {-11, 8}, {-7, 4}, {-4, 3}, {6, 1}, {-7, 7}, {-8, -1},
        {-46, 13}, {3, 9}, {16, 8}, {5, 7}, {-2, -3}, {-5, 8}, {-9, 2}, {-7, 12},
    },
    {
        {-31, -9}, {-25, -12}, {-33, -16}, {-45, -32}, {-36, -27}, {-28, -3}, {-38, -9}, {-14, -3},
        {-24, -20}, {-3, 8}, {-35, -10}, {-13, -27}, {-22, -16}, {-26, -51}, {-26, -19}, {-36, -3},
        {-8, 0}, {-20, -7}, {-19, -23}, {-30, -24}, {-11, -28}, {-29, -45}, {-39, -36}, {-32, -23},
        {-11, 8}, {-18, -13}, {-16, -18}, {8, -27}, {-16, -36}, {3, -48}, {-25, -47}, {-16, -24},
        {-21, -11}, {-3, -16}, {-6, -19}, {-5, -29}, {11, -19}, {-16, -30}, {-18, -44}, {-31, -28},
        {-14, -8}, {0, 5}, {-7, 7}, {-5, -4}, {-12, -20}, {-9, -20}, {-21, -31}, {-40, -19},
        {-3, 20}, {-23, -3}, {-13, -13}, {-5, -16}, {-12, -16}, {-20, -14}, {-25, -22}, {-14, -13},
        {-9, -3}, {-1, 4}, {-12, -14}, {-29, -25}, {-34, -33}, {2, -14}, {-18, -13}, {2, -23},
    },
    {
        {-26, 0}, {-10, 13}, {-24, 11}, {-12, 1}, {-11, -7}, {-30, -22}, {-36, 12}, {-6, 25},
        {-12, 22}, {-2, 10}, {-20, 3}, {-3, -13}, {-20, -3}, {-14, -41}, {-9, -8}, {-25, 3},
        {-5, -6}, {-22, 0}, {-4, -16}, {-48, -16}, {-13, -28}, {-14, -15}, {-21, -27}, {-30, -14},
        {-13, 15}, {-4, -7}, {-6, -14}, {-20, -28}, {0, -33}, {-3, -43}, {-10, -26}, {-8, -21},
        {9, 3}, {-16, -31}, {10, -24}, {8, -29}, {-2, -39}, {-4, -26}, {-13, -34}, {-26, -16},
        {-12, -4}, {-9, 9}, {-9, -2}, {-6, -9}, {-2, -20}, {-20, -13}, {-22, -21}, {-28, -22},
        {-7, -2}, {-20, 10}, {-9, 8}, {-9, 8}, {-11, -23}, {-19, -16}, {-17, -14}, {-28, -32},
        {9, 21}, {-3, 10}, {2, -8}, {-3, -6}, {-7, -18}, {-10, -20}, {-24, -25}, {-7, 24},
    },
    {
        {-12, 12}, {-13, 12}, {-19, -1}, {-18, 2}, {-15, 10}, {-14, -9}, {-37, 23}, {-15, 1},
        {-34, -9}, {-6, 2}, {-26, -13}, {-10, -10}, {-27, -12}, {-15, -19}, {-15, -16}, {-20, 2},
        {-20, -4}, {-15, 4}, {-10, -15}, {-10, -18}, {-19, -33}, {-6, -22}, {-24, -29}, {-24, -20},
        {-13, 3}, {-7, 8}, {-4, -20}, {15, -20}, {11, -37}, {9, -40}, {-11, -37}, {-18, -27},
        {-3, -8}, {11, -18}, {-14, -20}, {13, -26}, {0, -23}, {3, -40}, {-1, -40}, {-26, -26},
        {-6, 5}, {-6, 12}, {-18, 2}, {-9, -8}, {3, -30}, {-12, -22}, {-24, -18}, {-45, -26},
        {-4, 14}, {-11, 11}, {-20, 13}, {-27, 5}, {-4, -4}, {-24, -25}, {-13, -24}, {-27, -23},
        {9, 21}, {7, -4}, {-10, -13}, {-4, -6}, {-2, -11}, {1, -23}, {-29, -34}, {-22, -24},
    },
    {
        {-18, 3}, {-17, 15}, {-26, -24}, {-16, -19}, {-20, -5}, {-14, -4}, {-26, 11}, {-16, 20},
        {-20, -8}, {-1, 11}, {-15, -5}, {-29, -21}, {-28, -4}, {-1, -24}, {-26, 6}, {-18, -10},
        {-23, -20}, {-26, -4}, {-22, -19}, {-21, -10}, {-9, -21}, {-6, -20}, {-18, -15}, {-22, -24},
        {3, 0}, {-15, -22}, {-7, -18}, {-8, -23}, {15, -24}, {-4, -30}, {-16, -25}, {-5, -14},
        {2, -15}, {10, -17}, {-13, -15}, {-4, -27}, {2, -24}, {2, -22}, {-11, -26}, {-19, -21},
        {-12, -15}, {-11, -3}, {-8, -7}, {-7, -1}, {1, -17}, {-18, -8}, {-19, -10}, {-37, -17},
        {-11, 7}, {-2, 9}, {-16, 6}, {-13, 2}, {-16, 9}, {-9, -4}, {-17, -4}, {-9, -6},
        {-23, -24}, {-6, -8}, {2, 1}, {-3, -2}, {-11, -19}, {1, -11}, {-15, -7}, {-4, -29},
    },
    {
        {-8, 8}, {-7, 28}, {-19, -15}, {-26, -20}, {-33, -26}, {-11, -1}, {-23, -1}, {-19, -24},
        {-11, -3}, {-8, -5}, {-19, 11}, {-16, 2}, {-16, -29}, {-11, -40}, {-27, 2}, {-19, -17},
        {-37, -31}, {-28, -38}, {-26, -40}, {-15, -21}, {-33, -31}, {-37, -37}, {-19, -41}, {-18, -15},
        {-26, -24}, {-17, -18}, {-11, -32}, {3, -26}, {2, -30}, {-16, -65}, {-27, -42}, {-19, -12},
        {-37, -38}, {-7, -31}, {-32, -37}, {-5, -9}, {-26, -37}, {-15, -23}, {-29, -31}, {-2, 3},
        {-10, -5}, {-25, -8}, {-22, -20}, {-6, -28}, {-11, -10}, {-20, -35}, {-30, -55}, {-24, -31},
        {-29, -26}, {-26, -19}, {-15, -14}, {-19, -11}, {-18, -33}, {-10, -28}, {-7, -16}, {-13, -28},
        {2, 13}, {-15, -30}, {-17, -37}, {-12, -21}, {-15, -59}, {5, -13}, {-9, -15}, {0, 5},
    },
    {
        {-7, 11}, {-10, 14}, {-42, -32}, {-24, -8}, {-39, -45}, {-25, -6}, {-1, 19}, {-13, 11},
        {-7, -4}, {-24, -23}, {-19, -22}, {-25, -15}, {-14, -9}, {-15, -37}, {-11, -3}, {-23, -5},
        {-31, -25}, {-15, -8}, {-6, -16}, {-21, -20}, {-38, -35}, {-29, -41}, {-15, -29}, {-48, -39},
        {-12, -12}, {-10, -20}, {-14, -31}, {-8, -29}, {5, -34}, {-7, -30}, {-5, -22}, {-37, -21},
        {-16, -25}, {-11, -22}, {-30, -29}, {-20, -26}, {-24, -35}, {-27, -46}, {-32, -49}, {-27, -23},
        {-9, 5}, {-10, 7}, {-9, -12}, {-19, -26}, {-28, -17}, {-18, -35}, {-30, -20}, {-43, -24},
        {12, 15}, {-21, -11}, {-25, -15}, {-20, -6}, {-20, -23}, {-38, -31}, {-20, -14}, {-33, -40},
        {-8, 21}, {0, 16}, {-18, -21}, {-11, 8}, {-26, -46}, {-21, -31}, {-18, -40}, {-7, -11},
    },
    {
        {-15, 22}, {-21, -4}, {-27, -6}, {-16, -1}, {-24, -51}, {-37, -17}, {-11, 29}, {-25, -9},
        {-15, -13}, {-16, -8}, {-34, -19}, {-29, -18}, {-17, -15}, {-29, -60}, {-23, -33}, {-6, 0},
        {-31, 8}, {-24, -28}, {-20, -32}, {-17, -26}, {-25, -34}, {-20, -33}, {-30, -51}, {-39, -17},
        {-12, -12}, {-7, -27}, {-11, -35}, {-9, -34}, {-7, -31}, {-18, -46}, {-24, -42}, {-31, -33},
        {-23, -17}, {-19, -18}, {-10, -15}, {-12, -47}, {-17, -25}, {-36, -36}, {-37, -42}, {-12, -1},
        {-22, -18}, {2, 4}, {-16, -17}, {-2, -19}, {-14, -25}, {0, -19}, {-32, -32}, {-31, -30},
        {-11, -13}, {-19, 2}, {-24, -13}, {-9, -10}, {-11, -14}, {-27, -10}, {-23, -27}, {-36, -39},
        {-8, -25}, {-9, -18}, {-10, -18}, {-9, -11}, {-29, -36}, {-20, -25}, {-5, 4}, {-20, -23},
    },
    {
        {-7, 14}, {-12, 13}, {-16, -22}, {-22, -20}, {-10, -14}, {-15, -16}, {-19, -3}, {-22, 1},
        {-28, -30}, {-8, -6}, {-19, -18}, {-30, -23}, {-9, -14}, {-22, -59}, {-10, 15}, {-7, 21},
        {-15, -1}, {-19, -39}, {-21, -31}, {-14, -25}, {-25, -20}, {-14, -34}, {-19, -28}, {-34, -27},
        {-23, -16}, {-23, -24}, {-21, -45}, {-10, -38}, {-17, -36}, {-14, -43}, {-11, -24}, {-27, -25},
        {-17, -21}, {-15, -25}, {-27, -39}, {-22, -25}, {-19, -37}, {-16, -29}, {-30, -44}, {-21, -15},
        {-18, -33}, {-16, -2}, {-2, -3}, {-17, -19}, {-23, -16}, {-18, -29}, {-31, -24}, {-13, -23},
        {-8, -8}, {-14, -9}, {-6, -4}, {-11, 13}, {-16, -17}, {-13, -13}, {-15, -31}, {-17, -16},
        {-2, 10}, {10, -1}, {-1, -2}, {-12, -12}, {-3, -14}, {-26, -9}, {3, -25}, {-2, 20},
    },
};
...
constexpr
#endif
Weight king_relative_opp_pawn_psqt[8][48] =
{
    {
        {33, 84}, {25, 91}, {-11, 54}, {-15, -4}, {3, -60}, {5, -79}, {16, -95}, {7, -61},
        {-19, 49}, {-42, 40}, {-43, 37}, {-4, -7}, {6, -44}, {11, -67}, {19, -54}, {9, -44},
        {-7, 27}, {3, 16}, {-14, 22}, {-6, 5}, {-3, -3}, {3, -23}, {1, -20}, {2, -23},
        {4, 8}, {2, 4}, {-4, 4}, {-4, 2}, {-3, 3}, {-3, -2}, {-4, -11}, {-4, -9},
        {6, 2}, {6, -2}, {-2, -3}, {-2, -4}, {-5, 7}, {-4, 1}, {-11, -3}, {-5, -3},
        {2, 6}, {0, 1}, {-1, -6}, {-4, -4}, {-8, -1}, {-7, 2}, {-12, 6}, {-6, 1},
    },
    {
        {2, 22}, {3, 50}, {19, 81}, {-17, 82}, {-14, 38}, {15, -4}, {15, -69}, {39, -102},
        {-23, 39}, {-38, 51}, {-42, 41}, {-24, 34}, {-25, 33}, {-5, -5}, {-7, -13}, {10, -39},
        {-10, 14}, {-10, 10}, {-7, 9}, {4, -5}, {-4, 0}, {2, -8}, {-5, -3}, {-2, -13},
        {-5, 8}, {-3, 1}, {2, 4}, {4, -3}, {1, -4}, {2, -1}, {-1, -5}, {0, -8},
        {-1, 5}, {-3, 5}, {6, 0}, {9, -2}, {1, 4}, {0, 2}, {-6, 5}, {-1, 0},
        {-1, -3}, {-1, 2}, {7, -2}, {9, -4}, {-2, 2}, {-2, 5}, {-3, 2}, {-1, -3},
    },
    {
        {15, 114}, {0, 90}, {-21, 82}, {-20, 1}, {-39, -17}, {-39, -26}, {-36, -24}, {-28, -14},
        {-28, 102}, {-24, 91}, {-20, 67}, {-22, 23}, {-12, -19}, {-4, -45}, {-13, -30}, {-15, -21},
        {13, 27}, {-5, 29}, {-7, 30}, {4, 13}, {15, -14}, {24, -24}, {24, -29}, {13, -20},
        {-2, 0}, {-20, -3}, {5, 0}, {2, -1}, {9, -1}, {9, -6}, {15, -11}, {8, -9},
        {-15, -1}, {-1, -7}, {-17, 4}, {1, -2}, {6, 6}, {4, 7}, {3, 4}, {-2, 8},
        {-17, -1}, {-4, -5}, {-2, -7}, {6, -2}, {-4, 7}, {-5, 14}, {1, 8}, {3, 3},
    },
    {
        {-20, 37}, {-16, 62}, {-5, 91}, {-11, 84}, {-12, 49}, {-37, 27}, {-38, -4}, {-45, 0},
        {-42, 52}, {-57, 78}, {-35, 54}, {-9, 48}, {-17, 39}, {-32, 14}, {-24, 5}, {-19, -11},
        {-20, 21}, {-3, 13}, {10, 7}, {17, -6}, {17, -2}, {6, 3}, {-1, 0}, {11, -15},
        {2, -3}, {-11, -2}, {-5, -12}, {3, -21}, {-3, -8}, {8, -6}, {3, -5}, {9, -11},
        {0, -5}, {-1, -5}, {-4, -5}, {7, -10}, {-6, 0}, {5, -1}, {2, 1}, {2, 1},
        {-11, -4}, {1, -3}, {4, -5}, {-1, -3}, {-13, 7}, {-5, 9}, {2, 3}, {3, -5},
    },
    {
        {-6, 2}, {-40, -5}, {-29, -3}, {-27, -16}, {-39, -29}, {-24, -23}, {-36, -17}, {-36, 2},
        {-6, 36}, {-6, 29}, {-14, -1}, {-18, -44}, {-6, -52}, {-34, -48}, {-14, -31}, {-12, -26},
        {6, 9}, {-8, 27}, {10, 5}, {3, 4}, {14, -22}, {18, -28}, {19, -24}, {8, -22},
        {-16, 5}, {-5, 13}, {-4, 13}, {13, 17}, {17, 11}, {17, -1}, {26, -4}, {15, -3},
        {-23, -8}, {-11, -15}, {5, 5}, {9, 16}, {-8, 31}, {-10, 24}, {7, 17}, {-1, 16},
        {-12, -16}, {-15, -13}, {-22, -10}, {-10, -2}, {-7, 21}, {-7, 25}, {-4, 22}, {-27, 22},
    },
    {
        {-10, 9}, {-28, 5}, {-17, 5}, {-26, -19}, {-16, 4}, {-23, 0}, {-27, -8}, {-27, -3},
        {-14, 15}, {10, 23}, {4, 11}, {3, -7}, {-1, -23}, {-14, -23}, {-17, -15}, {-5, -18},
        {-11, 18}, {-9, 26}, {23, 14}, {16, 5}, {13, -5}, {33, -10}, {10, -2}, {1, -9},
        {-12, 19}, {-9, 21}, {13, 9}, {15, 5}, {13, 7}, {14, 11}, {4, 13}, {5, 2},
        {1, 9}, {5, 2}, {-2, -5}, {0, -4}, {-10, 9}, {-6, 17}, {-9, 21}, {-4, 17},
        {-18, 0}, {-6, -13}, {-28, -8}, {-22, -9}, {-7, -2}, {-4, 6}, {-12, 18}, {-22, 15},
    },
    {
        {-11, -23}, {-31, -41}, {-20, -17}, {-40, -56}, {-30, -40}, {-33, -33}, {-26, -23}, {-18, -25},
        {-22, -6}, {-22, -10}, {-23, -37}, {-23, -60}, {-12, -65}, {-27, -69}, {-25, -46}, {3, -47},
        {-5, 15}, {-16, 23}, {-19, -7}, {-4, -18}, {9, -27}, {-1, -30}, {2, -26}, {-3, -22},
        {-13, 9}, {1, 17}, {12, 1}, {-4, -2}, {6, 17}, {4, 9}, {5, 5}, {18, 2},
        {-18, -5}, {1, 6}, {-2, 1}, {-8, 18}, {6, 38}, {-1, 15}, {-9, 22}, {-3, 19},
        {-12, 5}, {-1, 2}, {-14, 2}, {-12, 6}, {18, 25}, {-5, 29}, {-11, 30}, {-15, 17},
    },
    {
        {-12, -14}, {-28, -10}, {-21, -18}, {-19, -42}, {-29, -39}, {-25, -21}, {-21, -10}, {-18, -19},
        {-29, -7}, {-11, -6}, {-15, -23}, {-15, -47}, {-24, -44}, {-14, -61}, {-8, -32}, {2, -29},
        {-2, 10}, {2, 12}, {2, 14}, {4, -11}, {-4, -15}, {26, -19}, {-1, -10}, {6, -12},
        {-11, 20}, {-10, 26}, {11, 23}, {6, 10}, {8, 3}, {7, 12}, {11, 15}, {-2, 10},
        {-1, 18}, {-9, 15}, {10, 19}, {-6, 13}, {-5, 16}, {-15, 29}, {-2, 25}, {-8, 20},
        {3, 21}, {-4, -1}, {-5, -1}, {-15, -3}, {-6, -4}, {-10, 16}, {-2, 30}, {-20, 26},
    },
};
...
Score evaluate_king_relative()
{
    ...
    r += evaluate_king_relative<~C, PAWN, 8>(king_relative_opp_pawn_psqt[king_idx16 / 2], flip);
    return r;
}
...
public:
    ...
    double evaluation_error(std::size_t offset, std::size_t size);
    int evaluate_features(const TunePosition& tp) const;
    bool find_best_value(TuneVariable& variable, double& best_error, int start_delta, std::size_t offset, std::size_t size);
...
void Tuner::parse_positions()
{
    ...
    for (auto& v : variables)
        value_indexes.insert({v.p, v.index});
    ...
    while (getline(std::cin, line))
    {
        ...
        tuning_positions.push_back({position, std::move(tune_features), base_score, expected});

        if (tuning_positions.size() % 500000 == 0)
        {
            double elapsed = std::chrono::duration_cast<std::chrono::duration<double> >(Clock::now() - start).count();
            std::cout << tuning_positions.size() << " elapsed: " << elapsed << " positions per sec: " << (tuning_positions.size() / elapsed) << std::endl;
        }
    }

    std::random_shuffle(tuning_positions.begin(), tuning_positions.end());

    std::cout << "Read " << pos_count << " positions, using " << tuning_positions.size() << ", discarded " << (pos_count - tuning_positions.size()) << std::endl;
}

int Tuner::evaluate_features(const TunePosition& tp) const
{
    Weight r = tp.base_score;
    for (auto f : tp.features)
    {
        r.mid += values[f.index] * f.value;
        r.end += values[f.index + 1] * f.value;
    }

    return evaluate_phase(tp.pos, r);
}

double Tuner::evaluation_error(std::size_t offset, std::size_t size)
{
    assert(offset + size <= tuning_positions.size());

    double error_sum = std::transform_reduce(
        std::execution::par_unseq,
        tuning_positions.begin() + offset, tuning_positions.begin() + offset + size,
        0.,
        std::plus{},
        [this](const TunePosition& tp)
        {
            int v = evaluate_features(tp);
...
bool Tuner::find_best_value(TuneVariable& variable, double& best_error, int start_delta, std::size_t offset, std::size_t size)
{
    ...
    for (int delta = start_delta; delta > 0; delta /= 2)
    {
        ...
        {
            int prev_value = values[variable.index];
            values[variable.index] += sd;
            double error = evaluation_error(offset, size);
            if (error >= best_error)
                values[variable.index] = prev_value;
            else
            {
                best_error = error;
                break;
...
void Tuner::add_variable(Weight& v)
{
    ...
    {
        variables.push_back({p, 0., static_cast<std::uint16_t>(values.size())});
        values.push_back(*p);
    }
}
...
void Tuner::tune()
{
    ...
    */
    ...
    double best_error = evaluation_error(0, tuning_positions.size());
    print_error(best_error);

    std::size_t offset = 0;
    std::size_t size = std::min<std::size_t>(2500000U, tuning_positions.size());

    for (int k = 0; k < 4; k++)
    {
        std::cout << "===== " << k << " =====" << std::endl;
        bool progress = false;
        best_error = evaluation_error(offset, size);
        print_error(best_error);
        for (auto& p : variables)
        {
            if (find_best_value(p, best_error, 1, offset, size))
                progress = true;
        }
        if (!progress)
            break;
        best_error = evaluation_error(0, tuning_positions.size());
        print_error(best_error);
        for (int n = 0; n < 4; n++)
        {
            ...
            for (auto& v : variables)
            {
                if (v.improvement <= cutoff)
                    break;
                find_best_value(v, best_error, 29 / (2 * n + k + 2), 0, tuning_positions.size());
            }
        }
