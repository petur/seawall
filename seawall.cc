...
constexpr
#endif
Score king_evals[32][4] =
{
    {{-39, -29}, {-21, 0}, {11, 6}, {33, 8}},
    {{-63, -114}, {-54, 66}, {-120, 220}, {-159, 269}},
    {{-11, -19}, {-10, -7}, {2, 4}, {19, 12}},
    {{16, -25}, {-19, 9}, {-82, 39}, {-73, 50}},
    {{3, 4}, {-2, 11}, {2, -4}, {10, -63}},
    {{13, -36}, {-21, -2}, {-51, 44}, {-25, 50}},
    {{-4, -2}, {-2, 1}, {2, -10}, {5, -42}},
    {{24, -14}, {-15, 8}, {-113, 53}, {-241, 95}},
    {{-38, -31}, {-22, -2}, {9, 7}, {34, 10}},
    {{-60, -111}, {-45, -9}, {-157, 97}, {-170, 173}},
    {{-13, -23}, {-8, -4}, {5, 6}, {17, 14}},
    {{16, -21}, {-24, 4}, {-68, 27}, {-80, 16}},
    {{4, 3}, {-2, 10}, {-17, 8}, {-12, -49}},
    {{11, -34}, {-21, -2}, {-63, 47}, {-26, 43}},
    {{1, -4}, {-1, 2}, {-26, 12}, {-55, 14}},
    {{23, -14}, {-19, 9}, {-89, 48}, {-195, 101}},
    {{-39, -60}, {-33, 8}, {0, 27}, {-17, 45}},
    {{-43, -80}, {-28, -27}, {-132, 60}, {-166, 90}},
    {{-1, -46}, {-16, -1}, {-8, 21}, {51, 31}},
    {{19, -19}, {-22, 2}, {-84, 27}, {-75, 18}},
    {{-8, 7}, {-4, 2}, {0, -20}, {-3, -79}},
    {{14, -34}, {-28, -12}, {-141, 76}, {-21, 48}},
    {{-16, 7}, {-1, -7}, {23, -39}, {-38, -68}},
    {{49, -18}, {-19, 10}, {-104, 35}, {-249, 106}},
    {{-45, -69}, {-21, 53}, {45, 168}, {34, 52}},
    {{-40, -85}, {-24, -29}, {-160, 41}, {-230, 110}},
    {{-13, -47}, {-13, 36}, {-30, 88}, {46, 83}},
    {{8, -26}, {-18, 28}, {-30, 84}, {5, 87}},
    {{-3, -1}, {5, -7}, {14, 0}, {6, -83}},
    {{15, -36}, {-19, 7}, {-133, 76}, {-18, 58}},
    {{-12, 7}, {1, -1}, {11, -55}, {12, -28}},
    {{52, -5}, {-27, 11}, {-85, 19}, {-231, 111}},
};
